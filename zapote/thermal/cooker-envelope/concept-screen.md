...
A discharge fault adds a separate common-mode heat case: the conditional NC VB resistor bank draws 27.0 W at 450 V with nominal 7.5 kΩ elements, or 40.5 W after one series-resistor short. At the 1% low-resistance bound these rise to 27.273 W and 40.909 W. These are sustained mains-attached, fan-off heat cases only if F2 stays closed or another verified mains source reaches VB. With F2 open and VB isolated, the same voltage gives initial instantaneous power from finite stored energy, not continuous dissipation; VD may remain replenished separately. None of these values belongs in the 110.6 W normal GBJ catalog comparison. The resistor-to-chassis/air path and peak temperatures need a no-fan fault model before the NC design can be promoted. The RH50 40 W at 70 °C mounted rating assumes its specified 536 cm² chassis fixture and cannot be credited to the unknown cooker mount. See [cooling handoffs](unit-handoffs.md) and [discharge U2 screen](../../discharge/topology-screen.md).
