...
const PARTS: &[(&str, &str, Option<&str>)] = &[
    ...
    ("r_vtop", "RC1206FR-07200KL", Some("200kohm")),
    ("r_vtop2", "RC1206FR-07200KL", Some("200kohm")),
    ("r_vtop3", "RC1206FR-07200KL", Some("200kohm")),
    ("r_vtop4", "RC1206FR-07200KL", Some("200kohm")),
    ("r_vtop5", "RC1206FR-07200KL", Some("200kohm")),
