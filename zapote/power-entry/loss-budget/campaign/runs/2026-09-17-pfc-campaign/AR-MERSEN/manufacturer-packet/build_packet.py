...
W("")
W("**Two devices must fail short for this loop to exist**, and the analysis")
W("treats both that way:")
W("")
...
W("  merely gated on, because a gate-controllable U9 could be turned off and")
W("  would then be an interrupter.")
...
W("")
W("The loop is therefore `bus+ -> U10 (short) -> a1 -> U9 (short) -> shunt ->")
W("bus-`, and the drive into it is the stored bank energy, not the mains source.")
W("")
...
W("")
W("The ends of that envelope are the two extreme cases for the fuse: lowest")
W("impedance (highest current), and highest impedance (longest time constant).")
