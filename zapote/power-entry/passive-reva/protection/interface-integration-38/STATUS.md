...
- **U7:** Current `source-build-05` has 296 references. The native preflight
  ...
  edge parity; 36 DRC violations, capped 499 unconnected items and 677 ERC
  warnings keep U7 open. See `NATIVE-DIAGNOSTIC-05.md`.
