...
- **U7:** Current `source-build-05` has 296 references. The native preflight
  ...
  edge parity; 22 DRC violations, capped 499 unconnected items and 383 ERC
  warnings keep U7 open. The library-footprint mismatch count is now zero.
  See `NATIVE-DIAGNOSTIC-05.md`, `NATIVE-DIAGNOSTIC-06.md` and
  `NATIVE-DIAGNOSTIC-07.md`.
