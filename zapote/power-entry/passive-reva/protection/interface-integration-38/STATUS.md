...
- **U7:** Current `source-build-05` has 296 references. The native preflight
  ...
  edge parity; 22 DRC violations, capped 499 unconnected items and 63 single-node-label
  ERC warnings keep U7 open. Library-footprint, symbol-library and
  footprint-link warning counts are now zero. See `NATIVE-DIAGNOSTIC-05.md`
  through `NATIVE-DIAGNOSTIC-08.md`.
