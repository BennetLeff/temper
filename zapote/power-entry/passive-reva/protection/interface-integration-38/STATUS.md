...
- **U7:** Current `source-build-06` has 296 references. The native preflight
  ...
  edge parity; the current `source-build-06` diagnostic has zero ERC and
  schematic-parity issues, seven placement/silkscreen DRC violations and
  capped 499 unconnected items. Thermal, assembly and isolation qualification
  remain open. See `NATIVE-DIAGNOSTIC-05.md` through
  `NATIVE-DIAGNOSTIC-09.md`.
