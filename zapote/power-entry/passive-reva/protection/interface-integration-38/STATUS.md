...
| U4 | `receiver_isolation.ato` compiles with exact AVR/ISO7741F/ISO7742F pin assignments. `audit.rs` passes seven tests, including deliberate pin/identity miswires. `gate-enable-corners.md` records an unresolved driver default-off condition. | Build **one joined** `power_entry_integrated_38.ato` with retained HOT/source memories, bounded history resets, actual F2/PFC and reservoir, watchdogs, supervisors, UCC27624/STW, and electrical corner analysis. The current fixture is partial. |
