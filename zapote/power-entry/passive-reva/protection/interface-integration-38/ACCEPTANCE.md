...
| Native board, production runtime and physical capture | **No accepted artifact or hash**. `placement-review/02/` retains an unrouted, unreviewed diagnostic with provisional stackup and exact source parity. |
| Stackup-aware native diagnostic | `stackup.json` SHA-256 `45bbfe06341177314ac3e9722ac2afcbf6eda05e8fc87cec052ade77aa98b488`; `tools/build_native.py` SHA-256 `0f188109cd150c28b1cb7d48688feaf41872bc15292d6058ad2156f14ebe8c3a`; `placement-review/02/` board SHA-256 `957ca67ada9338d91f9384695d3b3bf9d0f4a87263b471391700faf60760542d`, manifest SHA-256 `a20fcf73531417dc140bb3b9ce3c1fb309d7b7a0f909992839edeeba845c6051`; native geometry export SHA-256 `8a13ca76432e6f9d78c22153ccb138f9bb295b3efb55f10a893cd60dcb57e1a4` |
| Native board/source identity gate | `zapote-board.rs` SHA-256 `1568149a6d3917bb865b7c92e9d14cfe1f1c2e4d2c80931ebc032d8dc1fdec4f`; `board_cli.rs` SHA-256 `63066a07a65fd6a6bce890861b2fdce2c15e9b1720fda9e1eaadf4896bc6013a`; saved identity report SHA-256 `f022b0ab703b9535de45d9e3af41a5ead61e7eafa22c7aed07d6ba7018263a0e` |
| Native document/domain gate code | `zapote-drc/src/native_binding.rs` SHA-256 `c6cf4c7fbc50e649c2709117fde1f45e8a8a9b3720a796c99d8c4c4270ddbb2b`; `tests/native_multipad.rs` SHA-256 `55d3efc0edfffaa244d498c9288f528823cecd3ba77f6358e5a77463061e5ded`; `tests/rev38_native_domains.rs` SHA-256 `4f5b160c0cbadf0a332840a739d86748f72ecc8c094b6291625ff79fc4155d75` |
...
`NATIVE-DIAGNOSTIC-07.md`. The current `source-build-06` run is in
`NATIVE-DIAGNOSTIC-09.md`. Re-run the gates and update hashes if any listed input
...
| Native pad/copper extraction and strict binding | **PASS as transport only** | The regenerated board exposes manifest-checked source instance and MPN fields on 295 footprints and stable UUIDs on 1,089 physical pads. KiCad 10.0.4 extraction saves 1,070 assigned pad connections and 1,052 connectivity clusters with zero routed copper. Rust document binding passes; it is not a spacing verdict. |
| HOT/SELV native spacing and crossing mutation | **FAIL; full coverage OPEN** | `NATIVE-DOMAIN-SCREEN.md` records a bounded four-net, provisional 16.0 mm check: the DWW opposed-pad gap is 15.2 mm and other shelf-placement pairs fail. All other nets remain unclassified. A synthetic SELV-to-HOT trace fails the domain rule and cannot masquerade as the saved board. Reviewed full-net insulation rules, placement and routing remain required. |
