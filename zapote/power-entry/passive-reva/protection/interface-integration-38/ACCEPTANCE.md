...
board described in `NATIVE-DIAGNOSTIC-05.md` and its grid-corrected
schematic in `NATIVE-DIAGNOSTIC-06.md`. Re-run the gates and update hashes if any listed input
