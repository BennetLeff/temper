...
The own normal-prefix receipt binds the complete 0.662 s archive and accepts
only its prefix through the 0.6499999876940904 s selected endpoint, a 1.23e-8 s cutoff gap, one fault
edge, successful nondecreasing validation, and no boundary groups. Its 0.65–0.6583333333333 s crest
