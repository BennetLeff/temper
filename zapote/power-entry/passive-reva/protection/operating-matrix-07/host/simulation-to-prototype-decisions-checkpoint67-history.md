...
not bound instantaneous peaks. The other five settled fault cases remain
prepared/unrun. The F2-ZERO launch packet [`faults/settled-direct-capture-51/`](../faults/settled-direct-capture-51/)
is blocked until no other full solver is live and at least 16 GiB is free; the
current corrected resource observation is about 10.45 GiB, approximately 5.6
GiB short. The remaining archive forecast calls for roughly 30 GiB of additional
space; this is not a measured guarantee. The LL08 resource receipt recorded
