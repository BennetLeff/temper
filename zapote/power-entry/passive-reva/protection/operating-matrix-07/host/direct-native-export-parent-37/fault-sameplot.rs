...
fn main() -> Result<(), String> {
    ...
    let expected_signals = native_export::Schema::Fault42.names()[1..].join(" ");
    if signals != expected_signals { return Err("fault inventory does not match fixed native42 schema".into()); }
    ...
    let export = native_export::export(&args[4], native_export::Schema::Fault42,
    ...
    command(&format!("write reference.raw {}", native_export::Schema::Fault42.names().join(" ")))?;
