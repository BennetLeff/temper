...
SYMATTR SpiceModel TOR37_760800401_118u
SYMATTR Prefix x
SYMATTR InstName L
SYMATTR ModelFile WE-TORPFC.lib
SYMATTR Description WE-TORPFC Toroidal PFC Chokes\nAfter inserting, right-click on the symbol to select the part number.\nwww.we-online.com/catalog/WE-TORPFC\n\nPlease note disclaimer in WE-TORPFC.lib.
PIN -48 0 NONE 8
PINATTR PinName 1
