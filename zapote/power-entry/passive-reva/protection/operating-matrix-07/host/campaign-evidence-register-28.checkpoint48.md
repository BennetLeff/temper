...
| 5. Consolidate reproducible inputs, traces, screens, margins, prototype implications | This register; host/simulation-to-prototype-decisions.md; host/simulation-to-prototype-parent-review-14.json; source-bound receipts above | Current evidence, boundaries, and next gates are traceable; parent review confirms the interim decision aid. | The campaign report cannot be final until LL09, the five remaining settled faults, and remaining model/hardware questions are dispositioned explicitly. |
...
| LL09 | 132 VAC, 90%, 104.115 ohm | **LIVE; not accepted** | `line-load-direct-retry-47/` is running one full solver (session33042, runner66517, host66769, monitor66518). Its exact source was parent-verified; no complete receipt or electrical result exists yet. |
...
reduction. The latest storage forecast still projects roughly 30 GiB of
additional free space for all remaining archives, with the 10 GiB guard
authoritative; this is planning, not a measured bound. LL09 is now live as one
full solver after a fresh launch-gate check; its preflight reported 12.54249 GiB
free and 0.34249 GiB headroom above the 2.2 GiB archive forecast plus 10 GiB
floor. No other full solver is live. No external drive is available; do not
infer cleanup or request deletion of canonical evidence.
...
| SW-SHORT | **PREPARED, UNEXECUTED** | Failed-short channel is explicitly a protection-gap stress; gate low cannot earn interruption credit. Requires settled-prefix run and actual sustained channel-current report. |
