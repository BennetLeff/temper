...
|---|---|---|---|
| Input RMS voltage lower (107.999 V) | `acceptance.metrics.vrms_v=108.000 V`; 0.001000 V | LL01/LL02/LL03 | checkpoint53 JSON |
| Input RMS voltage upper (132.001 V) | `acceptance.metrics.vrms_v=132.000 V`; 0.001000 V | LL07/LL08/LL09 | checkpoint53 JSON |
...
Parent verification: all nine receipt hashes and embedded values match checkpoint53; threshold source and baseline metrics hashes match the accepted baseline receipt. The baseline is less limiting than the nine-point minima above. The smallest energy-residual screen margin is **30.259155 W (LL07)**, which is bookkeeping against the modeled energy screen, not heat or efficiency qualification. Armed and enabled fraction margins are **0.01** above the0.99 lower screen in all ten cases. Drift margin0.000844183195 corresponds to **0.084418 percentage points** below the0.5% limit. No new waveform analysis or acceptance was performed.
