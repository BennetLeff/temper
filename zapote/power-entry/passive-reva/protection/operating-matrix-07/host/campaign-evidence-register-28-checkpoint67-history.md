...
snapshot. The latest storage forecast still projects roughly 30 GiB of
additional free space for the remaining fault archives, with the 10 GiB guard
authoritative. The next F2-ZERO packet (`faults/settled-direct-capture-51/`)
requires at least 16 GiB free (10 GiB floor plus 6 GiB archive reserve) and no
other full solver; current free space is about 10.45 GiB, about 5.6 GiB short
of that launch gate. No external drive is available; do not infer cleanup or
request deletion of canonical evidence.
...
| F2-ZERO | **PREPARED, UNEXECUTED** | Same gates at a zero crossing; compact endpoint differs from finite forced endpoint, so actual trace endpoint/phase must be checked. Launch packet [`settled-direct-capture-51/`](../faults/settled-direct-capture-51/) remains blocked until no other solver is live and at least 16 GiB is free (current corrected resource observation: about 10.45 GiB). |
...
five settled faults remain. More free storage is still required.
