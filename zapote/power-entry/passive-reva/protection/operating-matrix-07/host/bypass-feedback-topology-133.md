...
The parent capture review records a complete 32,287,070-row archive to 0.662 s, raw SHA-256 `75f444f8e422e445c2e5d65f21760af1658f0b14f05dcd088d1c80cd2b87b0a1`, and an unchanged all-row screen failure: `VD=651.1730124191079 V > 500 V`. Adapter diagnostics report no detector rise, no latch-off, and its last channel-current sample above 0.1 A at the endpoint (not continuous conduction). Because the all-row screen precedes the formal checker, the bypass-flag rejection was not reached; this is not an acceptance or protection pass.
...
4. A negative-control test that cannot earn a protection pass; retain the actual validator rejection precedence and assess detector-independent waveform behavior separately.
