#!/bin/bash
# Record the frozen legacy strict-checker result for the completed SW-SHORT scan.
...
POST="$ROOT/faults/settled-sw-postcapture-69/full-SW-SHORT"
...
shasum -a 256 -c "$ROOT/faults/settled-sw-postcapture-69/tools-parent.sha256" >/dev/null
test -x "$CHECKER"
