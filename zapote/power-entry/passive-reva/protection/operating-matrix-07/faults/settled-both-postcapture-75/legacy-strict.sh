#!/bin/bash
# Record the frozen legacy strict-checker result for the completed BOTH-SHORT scan.
...
POST="$ROOT/faults/settled-both-postcapture-75/full-BOTH-SHORT"
...
shasum -a 256 -c "$ROOT/faults/settled-both-postcapture-75/tools-parent.sha256" >/dev/null
test -x "$CHECKER"
