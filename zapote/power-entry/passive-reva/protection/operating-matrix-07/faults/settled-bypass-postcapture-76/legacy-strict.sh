#!/bin/bash
# Record the frozen legacy strict-checker result for the completed BYPASS-NEG scan.
...
POST="$ROOT/faults/settled-bypass-postcapture-76/full-BYPASS-NEG"
...
shasum -a 256 -c "$ROOT/faults/settled-bypass-postcapture-76/tools-parent.sha256" >/dev/null
test -x "$CHECKER"
