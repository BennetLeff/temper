...
`fd5c7f9e9703a5d0004bcd523798644068d0b378081361580cf7ca5e0d57ff199bb45`;
...
the branch currents and endpoint/event checks in the receipt. The as-written
prepared decks must not be launched from fresh zero-state cold start as if
they were settled fault evidence.
