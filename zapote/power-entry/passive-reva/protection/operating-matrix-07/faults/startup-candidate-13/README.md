...
This directory was mechanically copied from the hysteretic-driver candidate and rewritten for T_FAULT=7.500000000000e-2 s, TSTOP=8.900000000000e-2 s, and the explicitly supplied PREFAULT_WINDOW=1.000000000000e-2 s. It has not been simulated and carries no accepted operating-point claim.
