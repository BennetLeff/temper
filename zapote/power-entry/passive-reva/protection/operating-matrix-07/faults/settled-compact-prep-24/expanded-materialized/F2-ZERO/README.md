...
This directory was mechanically copied from the hysteretic-driver candidate and rewritten for T_FAULT=6.583333333333e-1 s, TSTOP=6.820000000000e-1 s, and the explicitly supplied PREFAULT_WINDOW=1.000000000000e-2 s. It has not been simulated and carries no accepted operating-point claim.
