# DIODE-SHORT prepared fault deck

Status: **PREPARED_UNEXECUTED**.

This directory was mechanically copied from the hysteretic-driver candidate and rewritten for T_FAULT=6.541666666667e-1 s, TSTOP=6.620000000000e-1 s, and the explicitly supplied PREFAULT_WINDOW=2.000000000000e-3 s. It has not been simulated and carries no accepted operating-point claim.
