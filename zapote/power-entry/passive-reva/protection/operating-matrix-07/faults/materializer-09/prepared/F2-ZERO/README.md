# F2-ZERO prepared fault deck

Status: **PREPARED_UNEXECUTED**.

This directory was mechanically copied from the hysteretic-driver candidate and rewritten for T_FAULT=1.200000000000e-5 s, TSTOP=2.000000000000e-5 s, and the explicitly supplied PREFAULT_WINDOW=1.000000000000e-6 s. It has not been simulated and carries no accepted operating-point claim.
