...
|---|---|---|---|
| 1 | Soft-start ramp (1.5 V precharge, 40 uA into VCOMP network, EDR inhibited, end at 98% VSENSE) | §8.3.1 (p. 14), Fig. 23 | Detailed loop dynamics **NULL** (missing: large-signal comp-network response). Bounded input only: first-trip energy 42.4 mJ typ → ≤5 worst-case DMAX cycles (§5). Wall-clock time-to-trip NULL. |
