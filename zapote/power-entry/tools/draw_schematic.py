...
LIBRARY = "PowerEntryUnit"
PIN_NAMES = {"U11":{"1":"HOT_GND","2":"ICOMP","3":"ISENSE","4":"FREQ","5":"VCOMP","6":"VSENSE","7":"VCC","8":"GATE"},"U9":{"1":"G","2":"D","3":"S"},"U10":{"1":"A1","2":"K","3":"A2"}}
...
def main(repo, source, output, receipt):
    ...
    d = [g._schematic_header("Standalone 1800 W Input Boost PFC", g.ROOT_UUID).replace("2026-07-15", "2026-09-12").replace('(paper "A3")','(paper "A1")'), "(lib_symbols"]
    ...
    table.write_text('(sym_lib_table (version 7)\n  (lib (name "PowerEntryUnit") (type "KiCad") (uri "${KIPRJMOD}/power-entry-unit.kicad_sym") (options "") (descr "Source-derived power-entry symbols"))\n)\n')
