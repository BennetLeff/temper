...
REQUIRED_NATIVE = (
    ...
    "connections", "connectivity_clusters", "traces", "vias",
)
...
def main() -> None:
    ...
    source_ids = {b["instance_id"] for b in source_bindings}
    observed_source = {key: net for key, net in observed.items() if key[0] in source_ids}
