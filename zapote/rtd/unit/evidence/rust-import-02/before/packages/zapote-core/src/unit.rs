...
use crate::{Component, Connection, ConnectivityCluster, GeometryConstraints, Trace, Via};
...
impl UnitInput {
    pub fn validate(&self) -> Vec<String> {
        ...
        {
            errors.push("unit model must provide a non-empty faults array".into());
        }
