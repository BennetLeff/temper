...
void mock_sm_reset(void) {
    ...
    mock_sm_state.rtd_service_ready = true;
}

#ifndef RTD_SERVICE_PRODUCTION
bool rtd_service_is_ready(void) { return mock_sm_state.rtd_service_ready; }
void mock_sm_set_rtd_service_ready(bool ready) { mock_sm_state.rtd_service_ready = ready; }
#endif
