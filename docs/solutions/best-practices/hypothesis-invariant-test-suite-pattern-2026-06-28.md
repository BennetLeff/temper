...
- `docs/solutions/best-practices/invariants-verify-model-not-reality-2026-07-09.md` — scope caveat on this pattern: invariants close *internal model consistency*, not *physical correspondence*; hardware validation is the complementary step
