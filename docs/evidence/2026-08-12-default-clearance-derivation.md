<!-- provenance: branch analysis/default-clearance-derivation, worktree /home/bennet/Desktop/temper-default-clearance, built on origin/main commit 812719e2aa8fc5be69448a1334e808b607a43970 (dirty=false at every measurement below -- `git status --porcelain` empty throughout). pcb/temper.kicad_pcb sha256=6928b7c8950a732f1991578f5ff7c080104c0847bf438ccd8bf2c75150544b64 and pcb/temper.kicad_pro sha256=f2d90755af04fea40357be3ba2ef94368a01b1afc34c450b42fad0b9e15a51ac -- both byte-identical to docs/evidence/2026-08-12-selv-net-assignment.md's recorded board, and NEITHER FILE WAS EVER WRITTEN during this investigation: every DRC measurement below ran against read-only scratch copies (outside the repo, under this session's scratchpad) carrying the real pcb/fp-lib-table, pcb/libs/, pcb/temper.kicad_pro, and a freshly regenerated .kicad_dru (via scripts/generate_kicad_dru.py's generate_dru(), written to the scratch dir, never to pcb/temper.kicad_dru). DRC measured with kicad-cli 10.0.5 (`kicad-cli --version`), via temper_placer.validation._drc_api.run_drc (single-thread-pinned KICAD_CONFIG_HOME, --all-track-errors), confirmed deterministic across 5 repeated runs. No subagents were dispatched for this investigation. -->
