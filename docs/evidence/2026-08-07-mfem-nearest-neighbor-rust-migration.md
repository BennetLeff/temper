<!-- provenance: commit=9e7391ecfc4216415e726831b8c9b18e1017c561 (persistent main commit introducing this evidence and the described migration; original authoring worktree ref was not retained) dirty=true (working-tree changes at authoring time: this document plus the diff and measurement script it describes) -->
