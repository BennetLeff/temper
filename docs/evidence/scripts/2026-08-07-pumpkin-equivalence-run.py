...
Usage:
    ...
    uv run --no-sync python docs/evidence/scripts/2026-08-07-pumpkin-equivalence-run.py [--quick]
...
def main() -> None:
    ...
    for model in corpora:
        # Model name updated 2026-08-11 (docs/evidence/scripts/2026-08-07-cpsat-equivalence-harness.py's
