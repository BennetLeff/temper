...
``docs/evidence/scripts/k3_swap_board_write_variantB.py``), with one deliberate
...
Usage:
    uv run --no-sync python docs/evidence/scripts/2026-08-04-r24-barrier-resolve.py
"""
...
# (docs/evidence/scripts/2026-08-04-r24-barrier-frontier.py), handed to CP-SAT so the
