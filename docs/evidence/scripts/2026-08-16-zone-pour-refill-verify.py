...
(docs/evidence/scripts/2026-08-16-zone-pour-seam-verify.py), splices them into
...
Usage: .venv/bin/python docs/evidence/scripts/2026-08-16-zone-pour-refill-verify.py
"""
