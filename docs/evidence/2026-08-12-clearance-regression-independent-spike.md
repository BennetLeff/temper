<!-- provenance: independent spike, worktree /home/bennet/Desktop/temper/.claude/worktrees/agent-a374c69e35366ad12, branch diagnose/clearance-regression, base commit d8062c6e6 (origin/main tip at start). pcb/** never modified -- every board file measured below is a scratch copy under /tmp; `git status --short pcb/` confirmed clean throughout except for the gitignored, always-regenerated pcb/temper.kicad_dru (matches every prior evidence doc's own convention). Committed board measured: pcb/temper.kicad_pcb sha256 6928b7c8950a732f1991578f5ff7c080104c0847bf438ccd8bf2c75150544b64 (identical to docs/evidence/2026-08-11-pad-connectivity-ground-truth.md's and power_pcb_dataset/drc_ceiling.json's recorded hash -- unchanged since the 386 baseline was measured). kicad-cli 10.0.5 at /home/bennet/.local/opt/kicad-10.0.5 (LD_LIBRARY_PATH covering root/usr/lib, root/usr/lib/python3/dist-packages, root/usr/lib/x86_64-linux-gnu, root/usr/lib/x86_64-linux-gnu/kicad/plugins/3d; KICAD_STOCK_DATA_HOME=root/usr/share/kicad). This spike ran deliberately without reading the parallel broad-characterization agent's output; a commit from that agent landed on this shared branch mid-session (`1d3446d9d`, touching a differently-named file) and was not read beyond its one-line git-log summary that `git log` surfaced incidentally. -->
