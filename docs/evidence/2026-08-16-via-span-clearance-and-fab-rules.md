...
[filled in after the fixed route completes]

| metric | v3 (pre-fix) | fixed route |
|---|---|---|
| shorting_items | 11 | TBD |
| annular_width | 68 | TBD |
| holes_co_located | 60 | TBD |
| via_dangling | 44 | TBD |
| drill_out_of_range | 20 | TBD (out of scope) |
