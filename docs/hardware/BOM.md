...
| C_TANK1, C_TANK2 | Tank Capacitor | FKP1U021507E00JSSD | WIMA | 2 | Radial 31.5x13mm | 150nF 1600VDC PP FKP1 — wired in parallel (300nF combined) |

> **`C_TANK1/2` MPN corrected**: source uses `FKP1U021507E00JSSD`, not `FKP1T021506B00`. The KEMET R76-series "(alt)" second-source line from the previous revision is dropped — it was never cross-checked against the corrected primary part's exact ratings, and this pass reconciles BOM-vs-source only, not general second-sourcing.
>
