...
> Formal decision: `docs/evidence/2026-08-16-ocp02-descope-decision.md`. No fielded sensing
> path exists: the OCP-02 CT (CST3015, T2) cannot reach the 12.6mm PD3
...
> re-scoping or deleting it is an owner decision (decision doc §4; implementation record
> `docs/evidence/2026-08-16-ocp02-descope-implementation.md`). OCP-01 remains the primary
> protection (50.1A hardware comparator + 40A firmware layer, `firmware/config.yaml`
