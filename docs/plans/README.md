...
*205 plan documents. Generated from frontmatter.*
...
| `draft` | 12 | -- |
| *(no frontmatter)* | 15 | Legacy documents predating the plan format. |
...
- [`2026-09-17-001-feat-deepseek-pcb-harness-s0-provider-transport-plan.md`](./2026-09-17-001-feat-deepseek-pcb-harness-s0-provider-transport-plan.md) — DeepSeek PCB Harness S0 Provider Transport - Plan
