...
swept: 2026-08-07
swept_basis: "landed exactly as specified: docs/TRACEABILITY.md, docs/traceability-registry.yaml, scripts/check_traceability.py, opt-in TRACEABILITY sentinel files"
---
