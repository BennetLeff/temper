...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("placer_core::placement_drc::tests::halving_is_exact_either_way", halving_is_exact_either_way),
        ("placer_core::placement_drc::tests::same_net_is_skipped_however_close", same_net_is_skipped_however_close),
        ("placer_core::placement_drc::tests::overlap_is_a_short_and_short_shadows_clearance", overlap_is_a_short_and_short_shadows_clearance),
        ("placer_core::placement_drc::tests::clearance_message_uses_three_decimals", clearance_message_uses_three_decimals),
        ("placer_core::placement_drc::tests::exactly_at_the_threshold_is_not_a_violation", exactly_at_the_threshold_is_not_a_violation),
        ("placer_core::placement_drc::tests::nan_coordinate_yields_no_violation_witness", nan_coordinate_yields_no_violation_witness),
        ("placer_core::placement_drc::tests::pair_order_is_i_then_j", pair_order_is_i_then_j),
    ];
