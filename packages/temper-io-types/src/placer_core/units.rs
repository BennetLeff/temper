...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("placer_core::units::tests::pi_constant_matches_numpy", pi_constant_matches_numpy),
        ("placer_core::units::tests::deg_to_rad_is_not_to_radians", deg_to_rad_is_not_to_radians),
        ("placer_core::units::tests::rad_to_deg_is_not_to_degrees", rad_to_deg_is_not_to_degrees),
        ("placer_core::units::tests::round_trip_is_not_assumed_exact", round_trip_is_not_assumed_exact),
        ("placer_core::units::tests::manhattan_signed_zero", manhattan_signed_zero),
        ("placer_core::units::tests::distance_is_symmetric_and_unfused", distance_is_symmetric_and_unfused),
    ];
