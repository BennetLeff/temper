...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("placer_core::netclass::tests::patterns_are_ascii_and_non_empty", patterns_are_ascii_and_non_empty),
        ("placer_core::netclass::tests::every_pattern_compiles", every_pattern_compiles),
        ("placer_core::netclass::tests::trailing_newline_trap", trailing_newline_trap),
        ("placer_core::netclass::tests::pe_is_word_bounded_not_substring", pe_is_word_bounded_not_substring),
        ("placer_core::netclass::tests::non_alnum_tail_is_leading_anchor_only", non_alnum_tail_is_leading_anchor_only),
        ("placer_core::netclass::tests::precedence_is_ground_power_hv_signal", precedence_is_ground_power_hv_signal),
        ("placer_core::netclass::tests::signal_is_the_complement", signal_is_the_complement),
        ("placer_core::netclass::tests::unicode_case_folding", unicode_case_folding),
