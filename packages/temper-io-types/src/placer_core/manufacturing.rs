...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("placer_core::manufacturing::tests::cpython_max_nan_is_left_biased", cpython_max_nan_is_left_biased),
        ("placer_core::manufacturing::tests::cpython_max_preserves_the_left_zero", cpython_max_preserves_the_left_zero),
        ("placer_core::manufacturing::tests::inflated_clearance_clamps_at_zero", inflated_clearance_clamps_at_zero),
        ("placer_core::manufacturing::tests::oshpark_keeps_the_default_registration", oshpark_keeps_the_default_registration),
    ];
