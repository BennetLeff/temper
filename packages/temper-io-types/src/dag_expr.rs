...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("dag_expr::tests::empty_source_is_syntax_error", empty_source_is_syntax_error),
        ("dag_expr::tests::bare_identifier_message_matches_python", bare_identifier_message_matches_python),
        ("dag_expr::tests::keyword_boundary_is_respected", keyword_boundary_is_respected),
        ("dag_expr::tests::empty_single_quote_is_none_wart", empty_single_quote_is_none_wart),
        ("dag_expr::tests::number_classification_matches_python", number_classification_matches_python),
        ("dag_expr::tests::error_positions_are_character_indices", error_positions_are_character_indices),
        ("dag_expr::tests::python_strip_covers_information_separators", python_strip_covers_information_separators),
        ("dag_expr::tests::newline_escape_does_not_close_a_string", newline_escape_does_not_close_a_string),
        ("dag_expr::tests::deep_nesting_is_bounded_not_overflowing", deep_nesting_is_bounded_not_overflowing),
        ("dag_expr::tests::nesting_cpython_accepts_is_not_rejected", nesting_cpython_accepts_is_not_rejected),
        ("dag_expr::tests::or_and_are_left_associative_binary", or_and_are_left_associative_binary),
    ];
...
#[cfg(any(test, feature = "wasm-registry"))]
#[allow(dead_code, unused_imports, clippy::unwrap_used, clippy::expect_used)]
pub(crate) mod depth_boundary {
    // test-only: `expect_err` IS the assertion here.  The `expect_used` allow
    // that licenses it is the generated OUTER attribute above; an inner
    // `#![allow(clippy::expect_used)]` as well is what clippy calls
    // `duplicated_attributes` + `mixed_attributes_style`, and CI runs clippy
    // with `--all-features`, which now includes `wasm-registry`.
    use super::*;
    ...
    // --- BEGIN generated by scripts/gen_wasm_test_registry.py: depth_boundary ---
    /// Every `#[test]` in this module, as a callable the `wasm32`
    /// entry point can invoke by index.  Generated because these
    /// functions are private to this module and unreachable from
    /// anywhere a registry could otherwise live.
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("dag_expr::depth_boundary::accepts_the_last_frame_inside_the_ceiling", accepts_the_last_frame_inside_the_ceiling),
        ("dag_expr::depth_boundary::rejects_the_first_frame_past_the_ceiling", rejects_the_first_frame_past_the_ceiling),
    ];
    // --- END generated by scripts/gen_wasm_test_registry.py: depth_boundary ---
}
