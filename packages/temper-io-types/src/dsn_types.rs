...
// --- BEGIN generated by scripts/gen_oracle_freeze.py: dsn_primitives ---
    ...
    pub(crate) mod frozen_dsn_tests {
        ...
        pub const WASM_TESTS: &[(&str, fn())] = &[
            ("dsn_types::frozen_dsn_tests::frozen_dsn_matches_golden_corpus", frozen_dsn_matches_golden_corpus),
            ("dsn_types::frozen_dsn_tests::frozen_dsn_corpus_is_non_vacuous", frozen_dsn_corpus_is_non_vacuous),
        ];
