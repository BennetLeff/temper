...
// --- BEGIN generated by scripts/gen_oracle_freeze.py: dsn_primitives ---
    ...
    #[cfg(any(test, feature = "wasm-registry"))]
    #[allow(dead_code, unused_imports, clippy::unwrap_used, clippy::expect_used)]
    pub(crate) mod frozen_dsn_tests {
        use super::*;
        ...
        // --- BEGIN generated by scripts/gen_wasm_test_registry.py: frozen_dsn_tests ---
        /// Every `#[test]` in this module, as a callable the `wasm32`
        /// entry point can invoke by index.  Generated because these
        /// functions are private to this module and unreachable from
        /// anywhere a registry could otherwise live.
        pub const WASM_TESTS: &[(&str, fn())] = &[
            ("dsn_types::tests::frozen_dsn_tests::frozen_dsn_matches_golden_corpus", frozen_dsn_matches_golden_corpus),
            ("dsn_types::tests::frozen_dsn_tests::frozen_dsn_corpus_is_non_vacuous", frozen_dsn_corpus_is_non_vacuous),
        ];
        // --- END generated by scripts/gen_wasm_test_registry.py: frozen_dsn_tests ---
    }
