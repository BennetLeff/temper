...
// NOT gated on anything but `wasm-registry`: this crate has no `python`
// feature to avoid, so any wasm build that asks for the registry compiles
// this module.  Generated by
// `scripts/gen_wasm_test_registry.py --crate temper-pcl-ir`.
...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("tests::all_pcl_kinds_round_trip_deterministically", all_pcl_kinds_round_trip_deterministically),
    ];
...
pub(crate) mod key_tests {
    ...
    // --- BEGIN generated by scripts/gen_wasm_test_registry.py: key_tests ---
    /// Every `#[test]` in this module, as a callable the `wasm32`
    /// entry point can invoke by index.  Generated because these
    /// functions are private to this module and unreachable from
    /// anywhere a registry could otherwise live.
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("key_tests::pair_identity_includes_b_and_is_symmetric", pair_identity_includes_b_and_is_symmetric),
    ];
    // --- END generated by scripts/gen_wasm_test_registry.py: key_tests ---
}
