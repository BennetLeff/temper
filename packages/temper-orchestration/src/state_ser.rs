...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("state_ser::tests::empty_state_round_trips", empty_state_round_trips),
        ("state_ser::tests::full_state_round_trips_field_for_field", full_state_round_trips_field_for_field),
        ("state_ser::tests::double_round_trip_is_stable", double_round_trip_is_stable),
        ("state_ser::tests::val_int_and_float_do_not_merge", val_int_and_float_do_not_merge),
        ("state_ser::tests::non_value_opaque_is_a_loud_error", non_value_opaque_is_a_loud_error),
        ("state_ser::tests::value_opaque_passes_through", value_opaque_passes_through),
        ("state_ser::tests::malformed_json_is_a_loud_error", malformed_json_is_a_loud_error),
    ];
