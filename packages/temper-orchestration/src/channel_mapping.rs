...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        (
            "channel_mapping::tests::find_paren_groups_matches_regex_semantics",
            find_paren_groups_matches_regex_semantics,
        ),
        (
            "channel_mapping::tests::tuple_lt_matches_cpython_pairwise",
            tuple_lt_matches_cpython_pairwise,
        ),
        (
            "channel_mapping::tests::sort_coordinate_order_is_stable_lexicographic",
            sort_coordinate_order_is_stable_lexicographic,
        ),
        (
            "channel_mapping::tests::py_min_max_first_wins_and_nan_keeps_incumbent",
            py_min_max_first_wins_and_nan_keeps_incumbent,
        ),
        (
            "channel_mapping::tests::two_pad_decision_minimizes_displacement",
            two_pad_decision_minimizes_displacement,
        ),
        (
            "channel_mapping::tests::two_pad_interior_waypoints_untouched",
            two_pad_interior_waypoints_untouched,
        ),
    ];
