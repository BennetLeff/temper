...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        (
            "stage::tests::stage_run_transforms_state",
            stage_run_transforms_state,
        ),
        (
            "stage::tests::stage_defaults_are_empty",
            stage_defaults_are_empty,
        ),
        (
            "stage::tests::stage_error_roundtrip_and_display",
            stage_error_roundtrip_and_display,
        ),
        (
            "stage::tests::stage_error_kind_semantics",
            stage_error_kind_semantics,
        ),
    ];
