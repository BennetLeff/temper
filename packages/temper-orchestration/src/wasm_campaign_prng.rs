...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        (
            "wasm_campaign_prng::tests::deterministic_in_seed",
            deterministic_in_seed,
        ),
        (
            "wasm_campaign_prng::tests::varies_with_seed",
            varies_with_seed,
        ),
        (
            "wasm_campaign_prng::tests::range_stays_in_bounds",
            range_stays_in_bounds,
        ),
        (
            "wasm_campaign_prng::tests::index_stays_in_bounds",
            index_stays_in_bounds,
        ),
    ];
