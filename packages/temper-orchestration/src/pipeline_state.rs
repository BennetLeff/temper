...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        #[cfg(feature = "python")]
        (
            "pipeline_state::tests::phase_member_names_map_exactly",
            phase_member_names_map_exactly,
        ),
        #[cfg(feature = "python")]
        (
            "pipeline_state::tests::phase_eq_and_hash_are_value_consistent",
            phase_eq_and_hash_are_value_consistent,
        ),
    ];
