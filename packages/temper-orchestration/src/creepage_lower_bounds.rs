...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("creepage_lower_bounds::tests::threshold_clique_reports_sound_area_contradiction", threshold_clique_reports_sound_area_contradiction),
        ("creepage_lower_bounds::tests::false_twin_class_contributes_one_member_and_keeps_bound_sound", false_twin_class_contributes_one_member_and_keeps_bound_sound),
        ("creepage_lower_bounds::tests::true_twin_class_contributes_all_members", true_twin_class_contributes_all_members),
        ("creepage_lower_bounds::tests::board_dimension_violation_is_reported_without_pair_requirements", board_dimension_violation_is_reported_without_pair_requirements),
        ("creepage_lower_bounds::tests::malformed_input_fails_closed", malformed_input_fails_closed),
        ("creepage_lower_bounds::tests::passing_area_bound_is_not_a_feasibility_claim", passing_area_bound_is_not_a_feasibility_claim),
    ];
