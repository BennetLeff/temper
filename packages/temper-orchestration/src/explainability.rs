...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        (
            "explainability::tests::truncate_matches_cpython_negative_stop",
            truncate_matches_cpython_negative_stop,
        ),
        (
            "explainability::tests::py_title_matches_enum_titles",
            py_title_matches_enum_titles,
        ),
        (
            "explainability::tests::py_float_fmt_nan_inf_lowercase",
            py_float_fmt_nan_inf_lowercase,
        ),
        (
            "explainability::tests::py_float_fmt_round_half_even",
            py_float_fmt_round_half_even,
        ),
    ];
