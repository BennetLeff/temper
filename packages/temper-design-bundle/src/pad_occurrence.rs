...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("pad_occurrence::tests::distinct_occurrences_of_the_same_pad_number_are_unequal", distinct_occurrences_of_the_same_pad_number_are_unequal),
        ("pad_occurrence::tests::same_pad_number_and_occurrence_are_equal", same_pad_number_and_occurrence_are_equal),
        ("pad_occurrence::tests::different_pad_numbers_at_the_same_occurrence_are_unequal", different_pad_numbers_at_the_same_occurrence_are_unequal),
        ("pad_occurrence::tests::accessors_round_trip_the_constructor_arguments", accessors_round_trip_the_constructor_arguments),
        ("pad_occurrence::tests::is_hashable_so_it_can_key_a_map_of_resolved_pads", is_hashable_so_it_can_key_a_map_of_resolved_pads),
    ];
