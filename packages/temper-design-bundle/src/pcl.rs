...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("pcl::tests::unknown_type_is_fatal", unknown_type_is_fatal),
        ("pcl::tests::pair_without_b_is_fatal", pair_without_b_is_fatal),
        ("pcl::tests::variants_preserve_structural_fields", variants_preserve_structural_fields),
    ];
...
pub(crate) mod real_pcl_tests {
    ...
    // --- BEGIN generated by scripts/gen_wasm_test_registry.py: real_pcl_tests ---
    /// Every `#[test]` in this module, as a callable the `wasm32`
    /// entry point can invoke by index.  Generated because these
    /// functions are private to this module and unreachable from
    /// anywhere a registry could otherwise live.
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("pcl::real_pcl_tests::full_temper_pcl_has_no_unsupported_types_and_on_side_needs_no_distance", full_temper_pcl_has_no_unsupported_types_and_on_side_needs_no_distance),
    ];
    // --- END generated by scripts/gen_wasm_test_registry.py: real_pcl_tests ---
}
