...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("isolation_authority::tests::contract_is_deterministic_and_role_complete", contract_is_deterministic_and_role_complete),
        ("isolation_authority::tests::baseline_is_role_resolved_and_review_required", baseline_is_role_resolved_and_review_required),
        ("isolation_authority::tests::value_drift_and_coverage_loss_fail_closed", value_drift_and_coverage_loss_fail_closed),
    ];
