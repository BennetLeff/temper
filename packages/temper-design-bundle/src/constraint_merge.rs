...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("constraint_merge::tests::minimum_rules_accept_stronger_authored_values", minimum_rules_accept_stronger_authored_values),
        ("constraint_merge::tests::maximum_rules_reject_weaker_authored_values", maximum_rules_reject_weaker_authored_values),
    ];
