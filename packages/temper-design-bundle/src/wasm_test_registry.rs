...
/// All 75 eligible tests, in a stable order.  Each entry is
...
pub const ALL: &[&[WasmTest]] = &[
    #[cfg(feature = "wasm-registry-design-bundle")] crate::atopile::bridge_tests::WASM_TESTS,
    ...
    #[cfg(feature = "wasm-registry-design-bundle")] crate::identity::strict_pin_map_tests::WASM_TESTS,
