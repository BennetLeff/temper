...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("netlist::tests::extracts_refs_from_comp_blocks", extracts_refs_from_comp_blocks),
        ("netlist::tests::empty_document_is_an_error", empty_document_is_an_error),
        ("netlist::tests::netlist_with_no_components_returns_empty_set", netlist_with_no_components_returns_empty_set),
        ("netlist::tests::ignores_ref_like_fields_outside_comp_nodes", ignores_ref_like_fields_outside_comp_nodes),
    ];
