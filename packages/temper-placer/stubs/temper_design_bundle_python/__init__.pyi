...
def isolation_authority_contract_json_py() -> str: ...

def evaluate_isolation_authority_json_py(request_json: str) -> str: ...
def regional_topology_snapshot_json_py(board_bytes: bytes, domain_manifest_bytes: bytes) -> str: ...
def validate_regional_topology_declaration_json_py(declaration_bytes: bytes, basis_bytes: bytes, board_bytes: bytes, predecessor_receipt_bytes: bytes, predecessor_manifest_bytes: bytes, domain_manifest_bytes: bytes, netlist_bytes: bytes, kicad_dru_bytes: bytes, candidate_set_bytes: bytes) -> str: ...
