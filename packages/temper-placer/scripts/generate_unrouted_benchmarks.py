...
# Ensure we can import from temper_placer
...
def generate_unrouted_benchmarks():
    ...
    for name, config in projects.items():
        ...
        try:
            ...
            rotations = sample_rotation_batch(state.rotation_logits, jax.random.PRNGKey(0), temperature=0.01)
            ...
            logger.info(f"    (Removed {strip_result.traces_removed} traces, {strip_result.vias_removed} vias)")
