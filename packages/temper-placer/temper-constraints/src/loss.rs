...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("loss::tests::test_tier_to_weight", test_tier_to_weight),
        ("loss::tests::test_adjacent_loss_zero_when_within_range", test_adjacent_loss_zero_when_within_range),
        ("loss::tests::test_adjacent_loss_positive_when_exceeds", test_adjacent_loss_positive_when_exceeds),
        ("loss::tests::test_separation_loss_zero_when_far_enough", test_separation_loss_zero_when_far_enough),
        ("loss::tests::test_separation_loss_positive_when_too_close", test_separation_loss_positive_when_too_close),
        ("loss::tests::test_zone_membership_loss_inside", test_zone_membership_loss_inside),
        ("loss::tests::test_zone_membership_loss_outside", test_zone_membership_loss_outside),
        ("loss::tests::test_alignment_loss_perfect", test_alignment_loss_perfect),
        ("loss::tests::test_alignment_loss_misaligned", test_alignment_loss_misaligned),
        ("loss::tests::test_edge_preference_loss_on_edge", test_edge_preference_loss_on_edge),
        ("loss::tests::test_edge_preference_loss_far_from_edge", test_edge_preference_loss_far_from_edge),
        ("loss::tests::test_anchored_loss_at_target", test_anchored_loss_at_target),
        ("loss::tests::test_anchored_loss_away_from_target", test_anchored_loss_away_from_target),
        ("loss::tests::test_loop_area_loss_zero_when_small", test_loop_area_loss_zero_when_small),
        ("loss::tests::test_loop_area_loss_positive_when_large", test_loop_area_loss_positive_when_large),
    ];
