...
from temper_placer.losses.grouping import GroupClusterLoss, ProximityLoss, GroupSeparationLoss
from temper_placer.losses.thermal import ThermalSpreadLoss, ThermalLoss
