...
def _astar_route_nlayer(
    ...
    for i in range(len(waypoints) - 1):
        ...
        via_drill_mm = net_rules.via_drill_mm if net_rules else 0.3
        # Generated by scripts/generate_kicad_dru.py as the unconditional
        # "PTH hole to hole" rule. Center spacing is the two equal drill
        # radii plus the required 0.5mm edge gap.
        min_via_center_spacing_mm = via_drill_mm + 0.5
        ...
        result_3d, _tier3_iterations, tier3_hit_iteration_cap = _route_segment_3d_diagnostic(
            ...
            net_id=net_id,
            prior_via_positions=via_positions,
            min_via_spacing_mm=min_via_center_spacing_mm,
