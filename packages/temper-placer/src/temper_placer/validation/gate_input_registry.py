...
_CI_SCRIPT_SURVEY: list[tuple[str, str, str]] = [
    ...
    ("sync_kicad_netclass_assignments.py", "pcb/temper.kicad_pro", "net-to-netclass assignment sync gate: verifies pcb/temper.kicad_pro derives net_settings.netclass_assignments from design_rules.py's TEMPER_NET_ASSIGNMENTS; probe harness deferred"),
    ...
    ("sync_kicad_netclass_assignments.py", "pcb/temper.kicad_pro", "net -> netclass assignment sync gate: checks that pcb/temper.kicad_pro assignments agree with TEMPER_NET_ASSIGNMENTS in design_rules.py; probe harness deferred"),
