"""
Pinned Python oracle for ``temper_placer/io/loop_loader.py`` (Wave 4, Phase 3).

This file is a VERBATIM copy of the pre-migration implementation of
``temper_placer/io/loop_loader.py`` as of commit ``e90991a2a`` (origin/main,
the Wave-4 Phase-3 base for the loaders migration -- candidate 2 of
``docs/plans/2026-08-02-001-feat-wave4-phase3-formats-io-plan.md``). Only
this docstring replaces the module's own; every statement below it is
...
here silently weakens the differential proof. If the module contract
