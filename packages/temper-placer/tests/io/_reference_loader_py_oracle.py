"""
Pinned Python oracle for ``temper_placer/io/reference_loader.py`` (Wave 4, Phase 3, candidate 5).

This file is a VERBATIM copy of the pre-migration implementation of
``temper_placer/io/reference_loader.py`` as of commit ``79ab9bd0e`` (the
