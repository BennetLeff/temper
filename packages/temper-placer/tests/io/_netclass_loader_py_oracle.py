"""Verbatim pre-migration copy of temper_placer/io/netclass_loader.py.

Pinned at origin/main f2b09d846 (2026-08-04), the commit the Wave 4 Phase 3
netclass_loader migration started from. Do NOT edit this file: it is the
differential oracle. The migration's Rust port must reproduce this behavior
bit-for-bit (see tests/io/test_netclass_loader_rust_differential.py).
"""
