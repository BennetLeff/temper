...
"""
        ...
        allowed_losses = {"overlap", "overlap_per_component", "total"}
...
"""
        ...
        expected = expected_base | expected_variants
...
"""
        ...
        expected_defaults = {"overlap", "boundary", "wirelength", "spread"}
        # Filter to base losses only (not per-component variants or total)
        base_losses = {
            name
