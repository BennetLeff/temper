# VERBATIM pre-migration oracle: _parse_modules.py (Wave 4 Phase 3 candidate 3, parse engine).
...
from ._kicad_types import PadData
...
def _extract_components_from_pcb(
    ...
    for fp in ki_board.footprints:
        ...
        rotated_cx, rotated_cy = rotate_local_to_world(cx_to_rotate, center_offset_y, rot_rad)
