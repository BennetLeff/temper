# VERBATIM pre-migration oracle: kicad_parser.py (Wave 4 Phase 3 candidate 3, parse engine).
# Copied from packages/temper-placer/src/temper_placer/io/kicad_parser.py at commit 79ab9bd0e.
...
from ._kicad_types import ParseResult
from ._parse_board import _extract_board_geometry, _extract_stackup
from ._parse_modules import (
    _extract_components_from_pcb,
    _extract_pads_from_pcb,
)
from ._parse_nets import (
    _apply_safety_classifications,
    _extract_design_rules,
    _extract_nets_from_pcb,
)
from ._parse_tracks import _extract_traces_from_pcb, _extract_vias_from_pcb
