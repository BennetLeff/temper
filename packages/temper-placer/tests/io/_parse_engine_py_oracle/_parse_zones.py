# VERBATIM pre-migration oracle: _parse_zones.py (Wave 4 Phase 3 candidate 3, parse engine).
# Copied from packages/temper-placer/src/temper_placer/io/_parse_zones.py at commit 79ab9bd0e.
