# VERBATIM pre-migration oracle: kicad_metadata.py (Wave 4 Phase 3 candidate 3, parse engine).
# Copied from packages/temper-placer/src/temper_placer/io/kicad_metadata.py at commit 79ab9bd0e.
