...
class TestConstraintsLoading:
    ...
    def test_load_constraints(self, constraints_path):
        ...
        has_clearance_rules = (
            len(constraints.component_spacing_rules) > 0 or len(constraints.net_class_rules) > 0
        )
        assert has_clearance_rules, (
            "Expected clearance rules in component_spacing_rules or net_class_rules"
        )
