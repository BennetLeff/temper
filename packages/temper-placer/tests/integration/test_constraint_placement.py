...
class TestEndToEnd:
    ...
    def test_constraint_types(self, temper_constraints):
        ...
        _has_soft = any(r.tier == "soft" for r in spacing_rules)
...
class TestPerformance:
    ...
    def test_compiler_performance(self, temper_constraints):
        ...
        compiler = ConstraintCompiler(temper_constraints)
        _filter_fn = compiler.compile_to_slot_filter()
        _scorer_fn = compiler.compile_to_slot_scorer()
