...
def test_star_ground_filtering():
    ...
    components = [Component(ref=f"U{i}", footprint="R0402", bounds=(1.0, 0.5)) for i in range(100)]
    ...
    hg = netlist_to_hypergraph(netlist, ignore_global_nets=True, global_net_threshold=50)
