"""Verbatim pre-migration copy of temper_placer/core/board.py.

Pinned at origin/main f2b09d846 (2026-08-04), the commit the Wave 4 Phase 3
board migration started from. Do NOT edit this file: it is the differential
oracle. The migration's Rust port must reproduce this behavior bit-for-bit
(see tests/core/test_board_rust_differential.py).
"""
