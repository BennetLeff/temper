# Pinned Python oracle for ``temper_placer/report/formatter.py``
# (Wave 4, Phase 5 migration to ``temper-io-types``).
#
# This file is a VERBATIM copy of the pre-migration implementation as of
# origin/main (the Wave-4 Phase-5 base). The only difference from the
# original module is this header. The Rust migration must reproduce every
# behaviour here bit-identically; any edit to this file silently weakens
