"""
D6 run-orchestration oracle for `deterministic/stages/via_validation.py`.
...
Rust port (`temper-orchestration`'s `ViaValidationStage` /
`ViaDeduplicationStage`) is the differential subject.
"""
