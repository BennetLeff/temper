...
#   packages/temper-placer/src/temper_placer/deterministic/stages/_grid_stage.py
...
import tests.deterministic._grid_fence_py_oracle as _grid_fence
import tests.deterministic._grid_hv_py_oracle as _grid_hv
from tests.deterministic._grid_core_py_oracle import ClearanceGrid
