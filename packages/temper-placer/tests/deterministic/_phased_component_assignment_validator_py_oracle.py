...
# at the D4 dispatch base (origin/main, 3848fcb2). The file has no relative
# imports to rewrite -- the two lazy imports inside
# validate_phased_component_assignment_hv are already absolute and resolve
# against the real package, exactly as in production.
#
