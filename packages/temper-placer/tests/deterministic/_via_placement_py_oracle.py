"""VERBATIM pre-migration oracle for ``deterministic/geometry/via_placement.py``.

Wave 4, Phase 5, first slice (deterministic leaf stages). Pinned from
``packages/temper-placer/src/temper_placer/deterministic/geometry/via_placement.py``
