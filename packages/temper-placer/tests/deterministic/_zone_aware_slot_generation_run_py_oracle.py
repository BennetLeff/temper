...
# at the D5 dispatch base (origin/main 66f84b87). Relative imports are
# adapted to absolute paths so the oracle imports from the test tree; every
# other line is the verbatim pre-migration source (run orchestration,
# _isolation_filter, _get_copper_zones, _hv_clearance_overrides,
# _resolve_pin_pitch_mm, _is_slot_in_copper_zone, and the leaf-kernel
# delegation helpers).
#
