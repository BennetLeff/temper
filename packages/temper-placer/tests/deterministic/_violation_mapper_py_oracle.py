# VERBATIM pre-migration oracle for ``deterministic/feedback/violation_mapper.py``.
# Wave 4, Phase 5 (deterministic hubs slice). Pinned from
# ``packages/temper-placer/src/temper_placer/deterministic/feedback/violation_mapper.py``
