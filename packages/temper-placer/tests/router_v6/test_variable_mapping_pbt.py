...
@given(
    lits=st.lists(st.tuples(st.integers(0, 10), st.booleans()), min_size=1, max_size=20),
    mv=st.integers(0, 10),
)
@settings(max_examples=100, deadline=30000)
...
@given(
    names=st.lists(
        st.text("abcdefghijklmnopqrstuvwxyz_", min_size=1, max_size=16), min_size=0, max_size=30
    )
)
@settings(max_examples=100, deadline=30000)
