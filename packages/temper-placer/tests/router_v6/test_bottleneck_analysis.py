...
def test_identify_bottlenecks_multiple_layers():
    ...
    capacities = {
        "F.Cu": LayerCapacity("F.Cu", 10000, 8000, 2000, 1.0, 5.0, 80),
        "In1.Cu": LayerCapacity("In1.Cu", 10000, 9000, 1000, 2.0, 6.0, 100),
        "B.Cu": LayerCapacity("B.Cu", 10000, 7000, 3000, 1.0, 4.0, 60),
    }
