            ...
            "fields": [
                {
                    ...
                    "pass_bar": {
                        ...
                        "across_perturbations": {
                            "name": "N",
                            "value": 5.0,
                            "because": "Statistical confidence",
                        },
                    },
                    "kill_criterion": {
            ...
            return _fake_placement(
                positions=[
                    [
                        float(
                            pert_idx
                            + {"no_field": 0, "cheap_heuristic": 1, "physics_field": 2}[arm_id]
                        ),
                        0.0,
                    ]
                ]
...
class TestTemporalGating:
    ...
    def test_created_at_post_dates_battery_run_raises(self):
        ...
        run_ts = datetime(2026, 7, 9, 0, 0, 0, tzinfo=UTC)
        ...
        with pytest.raises(ValueError, match="post-dates"):
            run_helps_battery(
                ...
                board=None,
                netlist=None,
                build_arm_placement=lambda *_: _fake_placement(),
                score_placement_fn=lambda *_: _fake_scorecard(0.0),
                scorer_id="physics_oracle",
            ...
            return _fake_placement(
                positions=[
                    [
                        float(
                            pert_idx
                            + {"no_field": 0, "cheap_heuristic": 1, "physics_field": 2}.get(
                                arm_id, 0
                            )
                        ),
                        0.0,
