# Pinned Python oracle for ``temper_placer/validation/drc_result.py``
# (Wave 4, Phase 2 contracts migration to ``temper-drc-rs``).
#
# VERBATIM copy of the pre-migration implementation as of origin/main
# commit 17553437d (the Wave-4 Phase-2 base). Only difference from the
# original module is this header. The Rust pyclasses must reproduce every
# behaviour here bit-identically; any edit silently weakens the
# differential proof.
#
"""
