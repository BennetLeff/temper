    ...
    def test_spacing_satisfied(self):
        constraints = PlacementConstraints(
            component_spacing_rules=[
                ComponentSpacingRule(
                    component_a="A", component_b="B", min_separation_mm=10.0, tier="hard"
                ),
            ]
        )
        ...
        constraints = PlacementConstraints(
            component_groups=[
                ComponentGroup(
                    ...
                    proximity_rules=[
                        ProximityRule(
                            component_a="A", component_b="B", max_distance_mm=20.0, tier="soft"
                        ),
                    ],
                )
            ]
        ...
        constraints = PlacementConstraints(
            component_groups=[
                ComponentGroup(
                    ...
                    proximity_rules=[
                        ProximityRule(
                            component_a="A", component_b="B", max_distance_mm=10.0, tier="hard"
                        ),
                    ],
                )
            ]
        ...
        constraints = PlacementConstraints(
            ...
            component_groups=[
                ComponentGroup(
                    ...
                    proximity_rules=[
                        ProximityRule(
                            component_a="C", component_b="D", max_distance_mm=15.0, tier="soft"
                        ),
                    ],
                )
            ],
