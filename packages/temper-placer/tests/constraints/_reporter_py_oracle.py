# Pinned Python oracle for ``temper_placer/constraints/reporter.py``
# (Wave 4, Phase 4 migration to ``temper-constraint-compiler``).
#
# This file is a VERBATIM copy of the pre-migration implementation as of
# commit ``aece7c372`` (origin/main, the Wave-4 Phase-4 base). The only
# difference from the original module is this header. The Rust migration
# must reproduce every behaviour here bit-identically; any edit to this
# file silently weakens the differential proof. If the module's contract
