"""Pinned Python oracle for ``temper_placer/regression/fingerprint.py`` (Wave 4, Phase 4).

VERBATIM copy of the pre-migration implementation of
``temper_placer/regression/fingerprint.py`` as of commit ``0a29f15e3`` (origin/main,
