"""Pinned Python oracle for ``temper_placer/regression/cp_sat_comparison.py`` (Wave 4, Phase 4).

VERBATIM copy of the pre-migration implementation of
``temper_placer/regression/cp_sat_comparison.py`` as of commit ``0a29f15e3`` (origin/main,
