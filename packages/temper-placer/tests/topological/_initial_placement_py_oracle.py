# PINNED ORACLE -- verbatim copy of packages/temper-placer/src/temper_placer/topological/initial_placement.py.
#
...
from tests.topological._zone_solver_py_oracle import ZoneAssignment
...
def generate_initial_placement(
    ...
    if force_iterations > 0:
        from tests.topological._force_refinement_py_oracle import apply_force_refinement
