...
#   packages/temper-placer/src/temper_placer/pipeline/dag_expr.py
# as it existed at commit c5875adadca33875b6060132aa979a73c3e22669
#
#   git blob sha1 : cccd0b768541d03784f786fa501b797b9417b317
#   sha256        : 5e56ad7789c501d34d1d317157f45fe443f1cc3e9070515ca521af5262a69064
#
# This is the R1a behavioural oracle for the Rust port in
# packages/temper-io-types/src/dag_expr.rs. It must keep the ORIGINAL
...
# tests/pipeline/test_dag_expr_rust_differential.py) recomputes the sha256 of
# everything below the header and fails if this file drifts.
#
# --- BEGIN PINNED BODY ---
