...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("geometric_metrics::tests::no_components_is_all_defaults", no_components_is_all_defaults),
        ("geometric_metrics::tests::overlapping_pair_is_counted", overlapping_pair_is_counted),
        ("geometric_metrics::tests::exact_touch_is_not_an_overlap", exact_touch_is_not_an_overlap),
        ("geometric_metrics::tests::zone_violation_detected_and_measured", zone_violation_detected_and_measured),
        ("geometric_metrics::tests::boundary_violation_detected", boundary_violation_detected),
        ("geometric_metrics::tests::hv_lv_clearance_needs_both_classes_nonempty", hv_lv_clearance_needs_both_classes_nonempty),
        ("geometric_metrics::tests::hv_lv_clearance_measured_when_mixed", hv_lv_clearance_measured_when_mixed),
        ("geometric_metrics::tests::nan_position_in_hv_lv_does_not_survive_the_accumulator_min", nan_position_in_hv_lv_does_not_survive_the_accumulator_min),
        ("geometric_metrics::tests::pow_used_not_multiplication_in_hypot", pow_used_not_multiplication_in_hypot),
    ];
