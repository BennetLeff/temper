...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("copper_coverage::tests::rect_inside_board", rect_inside_board),
        ("copper_coverage::tests::keepout_rect_excludes_cells", keepout_rect_excludes_cells),
        ("copper_coverage::tests::hole_circle_excludes", hole_circle_excludes),
        ("copper_coverage::tests::polygon_mask_passthrough", polygon_mask_passthrough),
        ("copper_coverage::tests::trace_accumulate_min_caps_at_one", trace_accumulate_min_caps_at_one),
        ("copper_coverage::tests::trace_accumulate_nan_propagates", trace_accumulate_nan_propagates),
    ];
