...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("rtd::tests::test_resistance_to_code", test_resistance_to_code),
        ("rtd::tests::test_threshold_adc_codes", test_threshold_adc_codes),
        ("rtd::tests::test_max31865_voltage", test_max31865_voltage),
        ("rtd::tests::test_derive_window_known_corners", test_derive_window_known_corners),
        ("rtd::tests::test_derive_window_overlap_detected", test_derive_window_overlap_detected),
        ("rtd::tests::test_reference_divider", test_reference_divider),
    ];
