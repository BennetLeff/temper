...
// --- BEGIN generated by scripts/gen_oracle_freeze.py: operating_point ---
    ...
    pub(crate) mod frozen_op_tests {
        ...
        pub const WASM_TESTS: &[(&str, fn())] = &[
            ("operating_point::tests::frozen_op_tests::frozen_l_eff_matches_golden_corpus", frozen_l_eff_matches_golden_corpus),
            ("operating_point::tests::frozen_op_tests::frozen_thermal_chain_matches_golden_corpus", frozen_thermal_chain_matches_golden_corpus),
            ("operating_point::tests::frozen_op_tests::frozen_extreme_point_matches_golden_corpus", frozen_extreme_point_matches_golden_corpus),
            ("operating_point::tests::frozen_op_tests::frozen_interior_k_grid_matches", frozen_interior_k_grid_matches),
            ("operating_point::tests::frozen_op_tests::frozen_op_corpus_is_non_vacuous", frozen_op_corpus_is_non_vacuous),
        ];
