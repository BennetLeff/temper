...
pub(crate) mod tests {
    ...
    // module is the enclosing module's generated `WASM_TESTS` const,
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("hostmath::tests::pow_is_not_multiplication", pow_is_not_multiplication),
        ("hostmath::tests::pow_half_is_not_sqrt_everywhere", pow_half_is_not_sqrt_everywhere),
        ("hostmath::tests::exp_zero_is_one", exp_zero_is_one),
        ("hostmath::tests::trig_exact_points", trig_exact_points),
        ("hostmath::tests::py_max_keeps_first_argument_on_nan", py_max_keeps_first_argument_on_nan),
        ("hostmath::tests::py_min_keeps_first_argument_on_nan", py_min_keeps_first_argument_on_nan),
        ("hostmath::tests::np_maximum_propagates_nan_from_either_side", np_maximum_propagates_nan_from_either_side),
        ("hostmath::tests::np_clip_matches_numpy_semantics", np_clip_matches_numpy_semantics),
        #[cfg(target_os = "macos")] ("hostmath::tests::dlsym_resolves_on_macos", dlsym_resolves_on_macos),
    ];
