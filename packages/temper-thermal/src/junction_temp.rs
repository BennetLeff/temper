...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("junction_temp::tests::base_case_edge_mounting", base_case_edge_mounting),
        ("junction_temp::tests::edge_penalty", edge_penalty),
        ("junction_temp::tests::copper_benefit", copper_benefit),
        ("junction_temp::tests::overheating", overheating),
        ("junction_temp::tests::penalty_saturates_below_five_mm", penalty_saturates_below_five_mm),
        ("junction_temp::tests::copper_benefit_saturates_above_5000", copper_benefit_saturates_above_5000),
        ("junction_temp::tests::nan_penalty_keeps_first_argument", nan_penalty_keeps_first_argument),
        ("junction_temp::tests::nan_copper_benefit_keeps_first_argument", nan_copper_benefit_keeps_first_argument),
        ("junction_temp::tests::zero_power_is_exactly_ambient", zero_power_is_exactly_ambient),
        ("junction_temp::tests::op_order_product_before_add", op_order_product_before_add),
    ];
