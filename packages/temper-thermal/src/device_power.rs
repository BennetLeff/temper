...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        #[cfg(not(target_arch = "wasm32"))] ("device_power::tests::host_libm_symbols_actually_resolve", host_libm_symbols_actually_resolve),
        ("device_power::tests::diode_closed_form", diode_closed_form),
        ("device_power::tests::igbt_energy_method", igbt_energy_method),
        ("device_power::tests::waveform_fallback_zero_f_sw_is_conduction_only", waveform_fallback_zero_f_sw_is_conduction_only),
        ("device_power::tests::mosfet_uses_pow_not_mul", mosfet_uses_pow_not_mul),
        ("device_power::tests::nan_rdson_selects_v_ce_sat_branch", nan_rdson_selects_v_ce_sat_branch),
        ("device_power::tests::energy_method_additivity_order", energy_method_additivity_order),
    ];
