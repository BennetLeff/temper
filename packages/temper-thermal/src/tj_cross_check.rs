...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("tj_cross_check::tests::distance_known_values", distance_known_values),
        ("tj_cross_check::tests::device_cross_check_known", device_cross_check_known),
        ("tj_cross_check::tests::conservative_max_nan_first_wins", conservative_max_nan_first_wins),
    ];
