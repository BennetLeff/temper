...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("fdm::tests::test_assembly_matches_reference", test_assembly_matches_reference),
        ("fdm::tests::test_trace_coverage_matches_reference", test_trace_coverage_matches_reference),
        ("fdm::tests::test_trace_coverage_off_grid_returns_zeros", test_trace_coverage_off_grid_returns_zeros),
        ("fdm::tests::test_trace_coverage_degenerate_segment", test_trace_coverage_degenerate_segment),
    ];
