...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("combinator::types::tests::construct_conjoin", construct_conjoin),
        ("combinator::types::tests::construct_conditional", construct_conditional),
        ("combinator::types::tests::construct_restrict_domain", construct_restrict_domain),
    ];
