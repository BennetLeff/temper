...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("combinator::lower::tests::lower_conjoin_p2_p4", lower_conjoin_p2_p4),
        ("combinator::lower::tests::lower_p2_capacity_derivation", lower_p2_capacity_derivation),
        ("combinator::lower::tests::lower_p1_to_diffpair", lower_p1_to_diffpair),
        ("combinator::lower::tests::lower_conditional", lower_conditional),
        ("combinator::lower::tests::lower_restrict_domain", lower_restrict_domain),
        ("combinator::lower::tests::conjoin_soundness", conjoin_soundness),
    ];
