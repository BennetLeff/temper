...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("combinator::integration::tests::roundtrip_modelbuilder_rewrite", roundtrip_modelbuilder_rewrite),
        ("combinator::integration::tests::audit_compatibility", audit_compatibility),
        ("combinator::integration::tests::no_regression_atmostk_standalone", no_regression_atmostk_standalone),
        ("combinator::integration::tests::no_regression_diffpair_only", no_regression_diffpair_only),
    ];
