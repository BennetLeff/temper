...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("tension::tests::no_tensions_when_model_is_feasible", no_tensions_when_model_is_feasible),
        ("tension::tests::capacity_oversubscription_hard_conflict", capacity_oversubscription_hard_conflict),
        ("tension::tests::diffpair_capacity_hard_conflict", diffpair_capacity_hard_conflict),
        ("tension::tests::diffpair_capacity_2_is_fine", diffpair_capacity_2_is_fine),
        ("tension::tests::capacity_warning_at_90_percent", capacity_warning_at_90_percent),
        ("tension::tests::mutually_exclusive_diffpair_hard_conflict", mutually_exclusive_diffpair_hard_conflict),
        ("tension::tests::layer_restriction_starvation_check3", layer_restriction_starvation_check3),
        ("tension::tests::no_false_positive_for_feasible_model", no_false_positive_for_feasible_model),
        ("tension::tests::no_tension_for_capacity_only_model", no_tension_for_capacity_only_model),
        ("tension::tests::no_capacity_constraint_skip_gracefully", no_capacity_constraint_skip_gracefully),
    ];
