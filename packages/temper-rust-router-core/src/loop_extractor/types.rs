...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("loop_extractor::types::tests::test_to247_pin2_is_collector", test_to247_pin2_is_collector),
        ("loop_extractor::types::tests::test_to247_pin1_is_gate", test_to247_pin1_is_gate),
        ("loop_extractor::types::tests::test_unmapped_pin_returns_error_with_known_names", test_unmapped_pin_returns_error_with_known_names),
        ("loop_extractor::types::tests::test_to220_pin2_is_drain", test_to220_pin2_is_drain),
        ("loop_extractor::types::tests::test_extraction_error_display_contains_context", test_extraction_error_display_contains_context),
    ];
