...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("loop_extractor::classify::tests::test_q1_to247_no_mpn_is_power_switch", test_q1_to247_no_mpn_is_power_switch),
        ("loop_extractor::classify::tests::test_q_with_igbt_mpn", test_q_with_igbt_mpn),
        ("loop_extractor::classify::tests::test_c_with_bus_value", test_c_with_bus_value),
        ("loop_extractor::classify::tests::test_r_gate_is_gate_resistor", test_r_gate_is_gate_resistor),
        ("loop_extractor::classify::tests::test_unknown_ref_is_other", test_unknown_ref_is_other),
        ("loop_extractor::classify::tests::test_diode_is_diode", test_diode_is_diode),
    ];
