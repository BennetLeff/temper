...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("loop_extractor::extract::tests::test_detect_half_bridge_minimal", test_detect_half_bridge_minimal),
        ("loop_extractor::extract::tests::test_detect_half_bridge_no_switches", test_detect_half_bridge_no_switches),
        ("loop_extractor::extract::tests::test_auto_extract_loops_minimal_works", test_auto_extract_loops_minimal_works),
        ("loop_extractor::extract::tests::test_merge_manual_overrides_auto", test_merge_manual_overrides_auto),
    ];
