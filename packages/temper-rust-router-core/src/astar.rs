...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("astar::tests::test_finds_path_on_open_grid", test_finds_path_on_open_grid),
        ("astar::tests::test_path_is_connected_and_acyclic", test_path_is_connected_and_acyclic),
        ("astar::tests::test_blocked_grid_returns_empty", test_blocked_grid_returns_empty),
        ("astar::tests::test_iteration_cap_respected", test_iteration_cap_respected),
        ("astar::tests::test_congestion_changes_path", test_congestion_changes_path),
        ("astar::tests::test_octile_heuristic_values", test_octile_heuristic_values),
    ];
