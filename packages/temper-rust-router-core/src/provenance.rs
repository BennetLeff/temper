...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("provenance::tests::empty_core_returns_extraction_failed", empty_core_returns_extraction_failed),
        ("provenance::tests::single_capacity_core_maps_correctly", single_capacity_core_maps_correctly),
        ("provenance::tests::core_spanning_capacity_and_diffpair", core_spanning_capacity_and_diffpair),
        ("provenance::tests::core_index_out_of_bounds_skipped_gracefully", core_index_out_of_bounds_skipped_gracefully),
        ("provenance::tests::layer_restriction_in_core", layer_restriction_in_core),
    ];
