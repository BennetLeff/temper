...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("extraction::tests::test_expand_assignments_singleton_bundle", test_expand_assignments_singleton_bundle),
        ("extraction::tests::test_expand_assignments_false_class_var", test_expand_assignments_false_class_var),
    ];
