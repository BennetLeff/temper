...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("audit::tests::capacity_within_bounds", capacity_within_bounds),
        ("audit::tests::capacity_violation", capacity_violation),
        ("audit::tests::capacity_exact_limit", capacity_exact_limit),
        ("audit::tests::diff_pair_mismatch", diff_pair_mismatch),
        ("audit::tests::diff_pair_match", diff_pair_match),
        ("audit::tests::layer_violation", layer_violation),
        ("audit::tests::unsat_flag", unsat_flag),
        ("audit::tests::audit_completeness_all_n4_combos", audit_completeness_all_n4_combos),
    ];
