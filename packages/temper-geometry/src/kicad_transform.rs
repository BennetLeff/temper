...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("kicad_transform::tests::test_rotate_local_to_world_quadrant_anchors", test_rotate_local_to_world_quadrant_anchors),
        ("kicad_transform::tests::test_rotate_world_to_local_quadrant_anchors", test_rotate_world_to_local_quadrant_anchors),
        ("kicad_transform::tests::test_zero_rotation_is_exact_identity", test_zero_rotation_is_exact_identity),
        ("kicad_transform::tests::test_place_local_to_world_is_rotate_then_translate", test_place_local_to_world_is_rotate_then_translate),
        ("kicad_transform::tests::test_degrees_wrappers_match_radians_path", test_degrees_wrappers_match_radians_path),
        ("kicad_transform::tests::test_shapely_rotation_angle_deg_is_negation", test_shapely_rotation_angle_deg_is_negation),
        ("kicad_transform::tests::test_sign_flip_discriminates_at_quadrants", test_sign_flip_discriminates_at_quadrants),
    ];
