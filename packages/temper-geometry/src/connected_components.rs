...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("connected_components::tests::test_empty_grid", test_empty_grid),
        ("connected_components::tests::test_all_background", test_all_background),
        ("connected_components::tests::test_all_foreground_is_one_component", test_all_foreground_is_one_component),
        ("connected_components::tests::test_single_isolated_cell", test_single_isolated_cell),
        ("connected_components::tests::test_diagonal_touch_is_connected_8way", test_diagonal_touch_is_connected_8way),
        ("connected_components::tests::test_checkerboard_is_all_one_component_under_8_conn", test_checkerboard_is_all_one_component_under_8_conn),
        ("connected_components::tests::test_spiral_matches_flood_fill_reference", test_spiral_matches_flood_fill_reference),
        ("connected_components::tests::test_many_small_components_matches_flood_fill_reference", test_many_small_components_matches_flood_fill_reference),
        ("connected_components::tests::test_dense_random_matches_flood_fill_reference", test_dense_random_matches_flood_fill_reference),
        ("connected_components::tests::test_non_square_grids", test_non_square_grids),
        ("connected_components::tests::test_border_touching_components", test_border_touching_components),
        ("connected_components::tests::test_labels_are_first_encounter_raster_order", test_labels_are_first_encounter_raster_order),
    ];
