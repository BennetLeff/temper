...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("grid_utils::tests::snap_half_even", snap_half_even),
        ("grid_utils::tests::snap_negative_zero_normalised", snap_negative_zero_normalised),
        ("grid_utils::tests::snap_non_finite_errors", snap_non_finite_errors),
        ("grid_utils::tests::nudge_empty", nudge_empty),
        ("grid_utils::tests::nudge_both_ends", nudge_both_ends),
        ("grid_utils::tests::nudge_threshold_is_strict", nudge_threshold_is_strict),
    ];
