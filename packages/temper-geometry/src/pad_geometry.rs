...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        #[cfg(not(target_arch = "wasm32"))] ("pad_geometry::tests::host_libm_symbols_actually_resolve", host_libm_symbols_actually_resolve),
        ("pad_geometry::tests::pow2_is_exact_where_powi_is_not", pow2_is_exact_where_powi_is_not),
        ("pad_geometry::tests::py_hypot_matches_cpython_on_the_top_binade", py_hypot_matches_cpython_on_the_top_binade),
        ("pad_geometry::tests::py_hypot_lets_infinity_win_over_nan", py_hypot_lets_infinity_win_over_nan),
        ("pad_geometry::tests::test_corner_radius_shapes", test_corner_radius_shapes),
        ("pad_geometry::tests::test_support_radius_axis_aligned", test_support_radius_axis_aligned),
        ("pad_geometry::tests::test_rotation_maps_exact", test_rotation_maps_exact),
        ("pad_geometry::tests::test_barrier_gap_and_rotation", test_barrier_gap_and_rotation),
        ("pad_geometry::tests::test_rotation_searches_other_axis", test_rotation_searches_other_axis),
    ];
