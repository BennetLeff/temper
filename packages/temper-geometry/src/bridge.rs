...
fn sdf_circle(px: f64, py: f64, cx: f64, cy: f64, r: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_circle(&Point::new(px, py), cx, cy, r))
        .map_err(panic_to_err)
}

#[pyfunction]
fn sdf_rectangle(px: f64, py: f64, cx: f64, cy: f64, half_w: f64, half_h: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_rectangle(&Point::new(px, py), cx, cy, half_w, half_h))
        .map_err(panic_to_err)
}
...
fn sdf_union(d1: f64, d2: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_union(d1, d2)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_intersection(d1: f64, d2: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_intersection(d1, d2)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_subtraction(d1: f64, d2: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_subtraction(d1, d2)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_smooth_union(d1: f64, d2: f64, k: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_smooth_union(d1, d2, k)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_smooth_intersection(d1: f64, d2: f64, k: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_smooth_intersection(d1, d2, k)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_offset(d: f64, offset: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_offset(d, offset)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_round(d: f64, r: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_round(d, r)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_shell(d: f64, thickness: f64) -> PyResult<f64> {
    catch_unwind(|| crate::sdf::sdf_shell(d, thickness)).map_err(panic_to_err)
}

#[pyfunction]
fn sdf_to_mask(distances: Vec<f64>, threshold: f64) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::sdf::sdf_to_mask(&distances, threshold)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn sdf_to_penalty(distances: Vec<f64>, alpha: f64) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::sdf::sdf_to_penalty(&distances, alpha)))
        .map_err(panic_to_err)?
}
...
fn smooth_max(a: f64, b: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_max(a, b, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_max_axis(arr: Vec<f64>, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_max_axis(&arr, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_max_pair(a: Vec<f64>, b: Vec<f64>, alpha: f64) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::smooth::smooth_max_pair(&a, &b, alpha)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn smooth_min(a: f64, b: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_min(a, b, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_min_axis(arr: Vec<f64>, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_min_axis(&arr, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_min_pair(a: Vec<f64>, b: Vec<f64>, alpha: f64) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::smooth::smooth_min_pair(&a, &b, alpha)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn smooth_relu(x: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_relu(x, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_relu_penalty(x: f64, margin: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_relu_penalty(x, margin, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_leaky_relu(x: f64, alpha: f64, negative_slope: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_leaky_relu(x, alpha, negative_slope)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_abs(x: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_abs(x, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_clip(x: f64, min_val: f64, max_val: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_clip(x, min_val, max_val, alpha)).map_err(panic_to_err)
}

#[pyfunction]
fn smooth_step(x: f64, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::smooth_step(x, alpha)).map_err(panic_to_err)
}
...
fn weighted_average_smooth(values: Vec<f64>, weights: Vec<f64>, alpha: f64) -> PyResult<f64> {
    catch_unwind(|| crate::smooth::weighted_average_smooth(&values, &weights, alpha))
        .map_err(panic_to_err)
}

#[pyfunction]
fn get_alpha_schedule(start_alpha: f64, end_alpha: f64, epochs: usize) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::smooth::get_alpha_schedule(start_alpha, end_alpha, epochs)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn get_beta_schedule(start_beta: f64, end_beta: f64, epochs: usize) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::smooth::get_beta_schedule(start_beta, end_beta, epochs)))
        .map_err(panic_to_err)?
}
...
fn rotation_index_to_onehot(idx: usize, n_angles: usize) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::transform::rotation_index_to_onehot(idx, n_angles)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn rotation_degrees_to_onehot(deg: f64, allowed: Vec<f64>) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::transform::rotation_degrees_to_onehot(deg, &allowed)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn onehot_to_rotation_degrees(onehot: Vec<f64>, allowed: Vec<f64>) -> PyResult<f64> {
    catch_unwind(|| crate::transform::onehot_to_rotation_degrees(&onehot, &allowed))
        .map_err(panic_to_err)
}

#[pyfunction]
fn onehot_to_rotation_radians(onehot: Vec<f64>, allowed_rad: Vec<f64>) -> PyResult<f64> {
    catch_unwind(|| crate::transform::onehot_to_rotation_radians(&onehot, &allowed_rad))
        .map_err(panic_to_err)
}

#[pyfunction]
fn gumbel_softmax(logits: Vec<f64>, temperature: f64) -> PyResult<Vec<f64>> {
    catch_unwind(|| Ok(crate::transform::gumbel_softmax(&logits, temperature)))
        .map_err(panic_to_err)?
}

#[pyfunction]
fn sample_rotation(logits: Vec<f64>) -> PyResult<usize> {
    catch_unwind(|| crate::transform::sample_rotation(&logits)).map_err(panic_to_err)
}
