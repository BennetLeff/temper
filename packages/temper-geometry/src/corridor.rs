...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("corridor::tests::test_single_cell_rectangle", test_single_cell_rectangle),
        ("corridor::tests::test_buffer_expansion", test_buffer_expansion),
        ("corridor::tests::test_clamping_at_grid_bounds", test_clamping_at_grid_bounds),
        ("corridor::tests::test_empty_path", test_empty_path),
        ("corridor::tests::test_multi_cell_or_accumulates", test_multi_cell_or_accumulates),
        ("corridor::tests::test_mask_is_symmetric_under_path_reversal", test_mask_is_symmetric_under_path_reversal),
        ("corridor::tests::test_negative_buffer_below_underflow_wraps_like_numpy", test_negative_buffer_below_underflow_wraps_like_numpy),
        ("corridor::tests::test_negative_buffer_below_grid_length_wraps_to_empty", test_negative_buffer_below_grid_length_wraps_to_empty),
    ];
