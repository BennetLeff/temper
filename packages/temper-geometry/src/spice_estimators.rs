...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("spice_estimators::tests::test_loop_inductance_square", test_loop_inductance_square),
        ("spice_estimators::tests::test_loop_inductance_order_dependent_area", test_loop_inductance_order_dependent_area),
        ("spice_estimators::tests::test_infer_unit_time_and_voltage", test_infer_unit_time_and_voltage),
        ("spice_estimators::tests::test_infer_unit_current_energy_power", test_infer_unit_current_energy_power),
    ];
