...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("heuristics::tests::overlap_detects_a_real_conflict_and_reports_min_axis_overlap", overlap_detects_a_real_conflict_and_reports_min_axis_overlap),
        ("heuristics::tests::overlap_exactly_at_spacing_is_not_a_conflict", overlap_exactly_at_spacing_is_not_a_conflict),
        ("heuristics::tests::overlap_picks_the_first_conflict_in_given_order", overlap_picks_the_first_conflict_in_given_order),
        ("heuristics::tests::nudge_primary_follows_the_dominant_axis_and_sign", nudge_primary_follows_the_dominant_axis_and_sign),
        ("heuristics::tests::nudge_tie_goes_vertical_and_fallbacks_follow_oracle_order", nudge_tie_goes_vertical_and_fallbacks_follow_oracle_order),
        ("heuristics::tests::feasibility_reports_fit_flags_in_input_order", feasibility_reports_fit_flags_in_input_order),
        ("heuristics::tests::feasibility_accepts_either_orientation", feasibility_accepts_either_orientation),
        ("heuristics::tests::feasibility_margin_erodes_the_zone_in_both_axes", feasibility_margin_erodes_the_zone_in_both_axes),
        ("heuristics::tests::feasibility_area_totals_are_neumaier_compensated", feasibility_area_totals_are_neumaier_compensated),
        ("heuristics::tests::clamp_inverted_bounds_returns_hi_like_np_clip_not_f64_clamp", clamp_inverted_bounds_returns_hi_like_np_clip_not_f64_clamp),
        ("heuristics::tests::clamp_propagates_nan_from_any_operand", clamp_propagates_nan_from_any_operand),
        ("heuristics::tests::clamp_clips_to_the_valid_range_when_bounds_are_ordered", clamp_clips_to_the_valid_range_when_bounds_are_ordered),
    ];
