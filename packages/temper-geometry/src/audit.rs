...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("audit::tests::bbox_origin_centered", bbox_origin_centered),
        ("audit::tests::bbox_zero_size_collapses_to_point", bbox_zero_size_collapses_to_point),
        ("audit::tests::gap_separated_boxes", gap_separated_boxes),
        ("audit::tests::gap_touching_and_overlapping", gap_touching_and_overlapping),
        ("audit::tests::gap_is_symmetric", gap_is_symmetric),
        ("audit::tests::gap_nan_replicates_python_builtin_max", gap_nan_replicates_python_builtin_max),
        ("audit::tests::dist_known_points", dist_known_points),
        ("audit::tests::dist_is_symmetric", dist_is_symmetric),
        ("audit::tests::dist_non_finite_matches_math_dist", dist_non_finite_matches_math_dist),
    ];
