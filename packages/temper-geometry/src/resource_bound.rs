...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("resource_bound::tests::conflict_clusters_empty_and_single", conflict_clusters_empty_and_single),
        ("resource_bound::tests::conflict_clusters_disjoint_and_overlapping", conflict_clusters_disjoint_and_overlapping),
        ("resource_bound::tests::conflict_clusters_chain_merges", conflict_clusters_chain_merges),
        ("resource_bound::tests::cluster_union_bbox_basic_and_empty", cluster_union_bbox_basic_and_empty),
        ("resource_bound::tests::capacity_in_bbox_all_free_and_out_of_bounds", capacity_in_bbox_all_free_and_out_of_bounds),
        ("resource_bound::tests::fill_factor_bounds_and_empty", fill_factor_bounds_and_empty),
        ("resource_bound::tests::max_routable_empty_and_single", max_routable_empty_and_single),
        ("resource_bound::tests::max_routable_respects_capacity_limit", max_routable_respects_capacity_limit),
        ("resource_bound::tests::demand_budget_empty_and_utilization", demand_budget_empty_and_utilization),
    ];
