...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("copper_coverage::tests::test_square_centred", test_square_centred),
        ("copper_coverage::tests::test_edge_semantics_match_strict_comparisons", test_edge_semantics_match_strict_comparisons),
        ("copper_coverage::tests::test_fewer_than_three_vertices_is_empty", test_fewer_than_three_vertices_is_empty),
        ("copper_coverage::tests::test_concave_polygon_even_odd", test_concave_polygon_even_odd),
        ("copper_coverage::tests::test_offset_grid_alignment", test_offset_grid_alignment),
    ];
