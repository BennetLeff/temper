...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ...
        ("zone_generator::tests::keepout_union_pairwise_matches_linear_fold", keepout_union_pairwise_matches_linear_fold),
        ("zone_generator::tests::keepout_union_flat_evenodd_would_shrink", keepout_union_flat_evenodd_would_shrink),
        ("zone_generator::tests::large_halo_union_does_not_panic", large_halo_union_does_not_panic),
    ];
