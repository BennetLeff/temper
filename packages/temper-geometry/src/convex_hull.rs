...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("convex_hull::tests::test_empty_input", test_empty_input),
        ("convex_hull::tests::test_single_point", test_single_point),
        ("convex_hull::tests::test_two_points", test_two_points),
        ("convex_hull::tests::test_two_distinct_plus_duplicates", test_two_distinct_plus_duplicates),
        ("convex_hull::tests::test_all_duplicate_points", test_all_duplicate_points),
        ("convex_hull::tests::test_collinear_points", test_collinear_points),
        ("convex_hull::tests::test_collinear_axis_aligned", test_collinear_axis_aligned),
        ("convex_hull::tests::test_unit_right_triangle", test_unit_right_triangle),
        ("convex_hull::tests::test_unit_square", test_unit_square),
        ("convex_hull::tests::test_square_with_interior_point", test_square_with_interior_point),
        ("convex_hull::tests::test_square_with_duplicate_corners", test_square_with_duplicate_corners),
        ("convex_hull::tests::test_regular_hexagon_shoelace_cross_check", test_regular_hexagon_shoelace_cross_check),
        ("convex_hull::tests::test_point_order_does_not_matter", test_point_order_does_not_matter),
        ("convex_hull::tests::test_negative_coordinates", test_negative_coordinates),
        ("convex_hull::tests::test_large_random_point_cloud_matches_independent_reference", test_large_random_point_cloud_matches_independent_reference),
    ];
