...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("graph::tests::cluster_of_an_isolated_node_is_itself", cluster_of_an_isolated_node_is_itself),
        ("graph::tests::cluster_follows_adjacency_transitively_and_ignores_separation", cluster_follows_adjacency_transitively_and_ignores_separation),
        ("graph::tests::conflict_requires_adjacent_max_below_separated_min", conflict_requires_adjacent_max_below_separated_min),
        ("graph::tests::equal_bounds_are_satisfiable_and_not_a_conflict", equal_bounds_are_satisfiable_and_not_a_conflict),
        ("graph::tests::conflict_order_follows_edge_order_not_sorted_order", conflict_order_follows_edge_order_not_sorted_order),
        ("graph::tests::nan_distance_never_conflicts", nan_distance_never_conflicts),
    ];
