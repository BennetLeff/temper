...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("zone::tests::no_components_is_a_trivially_complete_assignment", no_components_is_a_trivially_complete_assignment),
        ("zone::tests::an_empty_candidate_list_makes_the_problem_unsolvable", an_empty_candidate_list_makes_the_problem_unsolvable),
        ("zone::tests::the_first_candidate_in_the_given_order_wins", the_first_candidate_in_the_given_order_wins),
        ("zone::tests::candidate_order_is_never_normalised", candidate_order_is_never_normalised),
        ("zone::tests::every_component_receives_a_zone_from_its_own_list", every_component_receives_a_zone_from_its_own_list),
    ];
