...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("bottleneck_kernels::tests::severity_edge_matrix", severity_edge_matrix),
        ("bottleneck_kernels::tests::aggregation_math", aggregation_math),
        ("bottleneck_kernels::tests::empty_and_zero_demand", empty_and_zero_demand),
        ("bottleneck_kernels::tests::floor_division_for_negative_total_demand", floor_division_for_negative_total_demand),
    ];
