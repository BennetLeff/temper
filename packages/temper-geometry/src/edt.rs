...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("edt::tests::test_empty_grid_all_background", test_empty_grid_all_background),
        ("edt::tests::test_full_grid_all_foreground_is_infinite", test_full_grid_all_foreground_is_infinite),
        ("edt::tests::test_single_seed_matches_brute_force", test_single_seed_matches_brute_force),
        ("edt::tests::test_sparse_seeds_matches_brute_force", test_sparse_seeds_matches_brute_force),
        ("edt::tests::test_dense_random_matches_brute_force", test_dense_random_matches_brute_force),
        ("edt::tests::test_thin_diagonal_feature_matches_brute_force", test_thin_diagonal_feature_matches_brute_force),
        ("edt::tests::test_all_background_row_and_column_matches_brute_force", test_all_background_row_and_column_matches_brute_force),
        ("edt::tests::test_non_square_aspect_ratio_matches_brute_force", test_non_square_aspect_ratio_matches_brute_force),
        ("edt::tests::test_single_row_and_single_column", test_single_row_and_single_column),
        ("edt::tests::test_symmetry_row_major_vs_transposed", test_symmetry_row_major_vs_transposed),
        ("edt::tests::test_anisotropic_sampling_matches_scaled_isotropic", test_anisotropic_sampling_matches_scaled_isotropic),
    ];
