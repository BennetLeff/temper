...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("layer_capacity_kernels::tests::typical_estimate", typical_estimate),
        ("layer_capacity_kernels::tests::max_one_floor", max_one_floor),
        ("layer_capacity_kernels::tests::zero_edges", zero_edges),
        ("layer_capacity_kernels::tests::inf_and_nan_raise_or_skip", inf_and_nan_raise_or_skip),
    ];
