...
def main():
    ...
    jar_path = args.jar or Path(os.environ.get("FREEROUTING_JAR", "bin/freerouting.jar"))
    ...
    routed_pcb_path = args.input_pcb.with_name(args.input_pcb.stem + "_routed.kicad_pcb")
