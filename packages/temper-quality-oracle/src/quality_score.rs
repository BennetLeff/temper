...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("quality_score::tests::placement_perfect_is_100", placement_perfect_is_100),
        ("quality_score::tests::placement_two_overlaps", placement_two_overlaps),
        ("quality_score::tests::placement_clamps_at_zero", placement_clamps_at_zero),
        ("quality_score::tests::placement_wirelength_penalty", placement_wirelength_penalty),
        ("quality_score::tests::placement_nan_wirelength_skips_penalty", placement_nan_wirelength_skips_penalty),
        ("quality_score::tests::placement_nan_avg_len_skips_penalty", placement_nan_avg_len_skips_penalty),
        ("quality_score::tests::drc_known_values", drc_known_values),
        ("quality_score::tests::overall_weighted_chains", overall_weighted_chains),
        ("quality_score::tests::interpretation_thresholds", interpretation_thresholds),
    ];
