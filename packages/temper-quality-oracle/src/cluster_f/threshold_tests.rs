...
// --- BEGIN generated by scripts/gen_wasm_test_registry.py: threshold_tests ---
/// Every `#[test]` in this module, as a callable the `wasm32`
/// entry point can invoke by index.  Generated because these
/// functions are private to this module and unreachable from
/// anywhere a registry could otherwise live.
pub const WASM_TESTS: &[(&str, fn())] = &[
    ("cluster_f::threshold_tests::hairpin_fires_at_exactly_160_degrees", hairpin_fires_at_exactly_160_degrees),
    ("cluster_f::threshold_tests::exactly_five_degrees_is_unreachable", exactly_five_degrees_is_unreachable),
    ("cluster_f::threshold_tests::order_traces_eps_is_exactly_0_1", order_traces_eps_is_exactly_0_1),
    ("cluster_f::threshold_tests::isolated_via_attachment_excludes_exactly_0_2", isolated_via_attachment_excludes_exactly_0_2),
    ("cluster_f::threshold_tests::channel_threshold_grouping_is_observable", channel_threshold_grouping_is_observable),
    ("cluster_f::threshold_tests::value_equal_channels_stay_distinct_buckets", value_equal_channels_stay_distinct_buckets),
    ("cluster_f::threshold_tests::fixed_formatting_differs_from_rust_only_on_nan", fixed_formatting_differs_from_rust_only_on_nan),
];
// --- END generated by scripts/gen_wasm_test_registry.py: threshold_tests ---
