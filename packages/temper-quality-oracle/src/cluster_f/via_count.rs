...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("cluster_f::via_count::tests::edge_distance_uses_the_variadic_min_nan_rule", edge_distance_uses_the_variadic_min_nan_rule),
        ("cluster_f::via_count::tests::empty_bbox_list_is_never_a_hit", empty_bbox_list_is_never_a_hit),
    ];
