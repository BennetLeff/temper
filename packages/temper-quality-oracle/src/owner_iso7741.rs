...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("owner_iso7741::tests::malformed_minimal_package_is_rejected_before_policy", malformed_minimal_package_is_rejected_before_policy),
        ("owner_iso7741::tests::generated_truth_space_is_finite_and_canonical", generated_truth_space_is_finite_and_canonical),
        ("owner_iso7741::tests::all_pass_stops_at_preliminary_review_without_a8", all_pass_stops_at_preliminary_review_without_a8),
        ("owner_iso7741::tests::failure_precedes_pending_and_reason_order_is_stable", failure_precedes_pending_and_reason_order_is_stable),
        ("owner_iso7741::tests::missing_truth_row_is_an_input_error_not_an_implicit_pass", missing_truth_row_is_an_input_error_not_an_implicit_pass),
        ("owner_iso7741::tests::digest_mismatched_preliminary_receipt_cannot_approve", digest_mismatched_preliminary_receipt_cannot_approve),
        ("owner_iso7741::tests::matching_favorable_receipt_approves_only_compatible_limitations", matching_favorable_receipt_approves_only_compatible_limitations),
        ("owner_iso7741::tests::lifecycle_allows_only_internal_then_preliminary_authority", lifecycle_allows_only_internal_then_preliminary_authority),
        ("owner_iso7741::tests::u7_rejected_internal_result_cannot_be_laundered_by_favorable_receipt", u7_rejected_internal_result_cannot_be_laundered_by_favorable_receipt),
        ("owner_iso7741::tests::u7_classifies_ambiguous_identity_and_evidence_only_requests", u7_classifies_ambiguous_identity_and_evidence_only_requests),
    ];
