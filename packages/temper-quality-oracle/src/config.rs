...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("config::tests::test_config_populates_thermal", test_config_populates_thermal),
        ("config::tests::test_config_populates_hv", test_config_populates_hv),
        ("config::tests::test_config_populates_lv", test_config_populates_lv),
        ("config::tests::test_config_loop_components", test_config_loop_components),
        ("config::tests::test_config_empty_netlist", test_config_empty_netlist),
        ("config::tests::test_config_loop_components_ge_2", test_config_loop_components_ge_2),
        ("config::tests::test_config_default_clearance", test_config_default_clearance),
    ];
