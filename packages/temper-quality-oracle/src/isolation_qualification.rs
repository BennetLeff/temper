...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("isolation_qualification::tests::all_pass_qualifies_and_order_is_canonical", all_pass_qualifies_and_order_is_canonical),
        ("isolation_qualification::tests::failure_precedes_pending", failure_precedes_pending),
        ("isolation_qualification::tests::slot_without_certification_is_stopped", slot_without_certification_is_stopped),
        ("isolation_qualification::tests::unavailable_straight_geometry_is_pending_not_a_pass", unavailable_straight_geometry_is_pending_not_a_pass),
        ("isolation_qualification::tests::straight_geometry_pass_without_measurement_fails_closed", straight_geometry_pass_without_measurement_fails_closed),
        ("isolation_qualification::tests::straight_geometry_requires_candidate_bound_source", straight_geometry_requires_candidate_bound_source),
        ("isolation_qualification::tests::missing_unknown_duplicate_and_geometry_mismatch_fail_closed", missing_unknown_duplicate_and_geometry_mismatch_fail_closed),
        ("isolation_qualification::tests::provenance_envelope_rejects_non_commit_and_invalid_protected_sets", provenance_envelope_rejects_non_commit_and_invalid_protected_sets),
        ("isolation_qualification::tests::campaign_requires_all_families_and_domains", campaign_requires_all_families_and_domains),
        ("isolation_qualification::tests::json_output_is_stable", json_output_is_stable),
    ];
