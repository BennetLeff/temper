...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        (
            "iso7741_gate_drive_qualification::tests::malformed_minimal_package_is_rejected_before_policy",
            malformed_minimal_package_is_rejected_before_policy,
        ),
        (
            "iso7741_gate_drive_qualification::tests::generated_truth_space_is_finite_and_canonical",
            generated_truth_space_is_finite_and_canonical,
        ),
        (
            "iso7741_gate_drive_qualification::tests::all_pass_stops_at_preliminary_review_without_a8",
            all_pass_stops_at_preliminary_review_without_a8,
        ),
        (
            "iso7741_gate_drive_qualification::tests::failure_precedes_pending_and_reason_order_is_stable",
            failure_precedes_pending_and_reason_order_is_stable,
        ),
        (
            "iso7741_gate_drive_qualification::tests::missing_truth_row_is_an_input_error_not_an_implicit_pass",
            missing_truth_row_is_an_input_error_not_an_implicit_pass,
        ),
        (
            "iso7741_gate_drive_qualification::tests::digest_mismatched_preliminary_receipt_cannot_approve",
            digest_mismatched_preliminary_receipt_cannot_approve,
        ),
        (
            "iso7741_gate_drive_qualification::tests::matching_favorable_receipt_approves_only_compatible_limitations",
            matching_favorable_receipt_approves_only_compatible_limitations,
        ),
        (
            "iso7741_gate_drive_qualification::tests::lifecycle_allows_only_internal_then_preliminary_authority",
            lifecycle_allows_only_internal_then_preliminary_authority,
        ),
        (
            "iso7741_gate_drive_qualification::tests::u7_rejected_internal_result_cannot_be_laundered_by_favorable_receipt",
            u7_rejected_internal_result_cannot_be_laundered_by_favorable_receipt,
        ),
        (
            "iso7741_gate_drive_qualification::tests::u7_classifies_ambiguous_identity_and_evidence_only_requests",
