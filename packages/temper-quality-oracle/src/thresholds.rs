...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("thresholds::tests::test_clearance_violation_detected", test_clearance_violation_detected),
        ("thresholds::tests::test_no_clearance_violation_when_far_apart", test_no_clearance_violation_when_far_apart),
        ("thresholds::tests::test_thermal_violation_detected", test_thermal_violation_detected),
        ("thresholds::tests::test_empty_config_no_violations", test_empty_config_no_violations),
        ("thresholds::tests::test_loop_area_violation_with_bad_score", test_loop_area_violation_with_bad_score),
    ];
