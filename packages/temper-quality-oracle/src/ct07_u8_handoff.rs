...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("ct07_u8_handoff::tests::pending_internal_result_never_has_a_handoff", pending_internal_result_never_has_a_handoff),
        ("ct07_u8_handoff::tests::malformed_timing_type_is_rejected_at_schema_boundary", malformed_timing_type_is_rejected_at_schema_boundary),
        ("ct07_u8_handoff::tests::favorable_result_publishes_only_ct07_handoff", favorable_result_publishes_only_ct07_handoff),
        ("ct07_u8_handoff::tests::negative_ruling_rejects_without_mutating_internal_result", negative_ruling_rejects_without_mutating_internal_result),
        ("ct07_u8_handoff::tests::missing_ruling_and_ambiguous_limitation_stop", missing_ruling_and_ambiguous_limitation_stop),
    ];
