...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("derivation::tests::test_derive_emi_loop_spacing", test_derive_emi_loop_spacing),
        ("derivation::tests::test_derive_thermal_clearance", test_derive_thermal_clearance),
        ("derivation::tests::test_derive_si_max_placement_dist", test_derive_si_max_placement_dist),
        ("derivation::tests::test_derive_hv_lv_isolation_default", test_derive_hv_lv_isolation_default),
        ("derivation::tests::test_derive_empty_spec", test_derive_empty_spec),
        ("derivation::tests::test_derived_distances_non_negative", test_derived_distances_non_negative),
    ];
