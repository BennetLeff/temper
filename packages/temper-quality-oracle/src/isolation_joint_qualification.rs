...
pub mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("isolation_joint_qualification::tests::exact_boundary_is_inclusive_and_fractional_terms_round_up", exact_boundary_is_inclusive_and_fractional_terms_round_up),
        ("isolation_joint_qualification::tests::over_budget_rejects_and_missing_signer_stops", over_budget_rejects_and_missing_signer_stops),
        ("isolation_joint_qualification::tests::duplicate_uncertainty_or_noncanonical_decimal_stops", duplicate_uncertainty_or_noncanonical_decimal_stops),
        ("isolation_joint_qualification::tests::negative_timing_and_missing_direct_endpoint_stop", negative_timing_and_missing_direct_endpoint_stop),
        ("isolation_joint_qualification::tests::approval_requires_every_captured_byte_binding", approval_requires_every_captured_byte_binding),
    ];
