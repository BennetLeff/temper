...
// Wave 4 — router_v6/resource_bound.py resource-exhaustion bin-packing
// kernels (conflict clustering, union bbox, free-area capacity, fill
// factor, and the two orchestration entry points).
#[cfg(feature = "python")]
