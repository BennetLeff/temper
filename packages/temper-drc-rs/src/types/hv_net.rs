...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::hv_net::tests::test_hv_net_construction", test_hv_net_construction),
        ("types::hv_net::tests::test_hv_net_below_threshold", test_hv_net_below_threshold),
        ("types::hv_net::tests::test_validate_hv_isolation_ok", test_validate_hv_isolation_ok),
        ("types::hv_net::tests::test_validate_hv_isolation_violation", test_validate_hv_isolation_violation),
        ("types::hv_net::tests::test_validate_hv_isolation_empty_signals", test_validate_hv_isolation_empty_signals),
    ];
