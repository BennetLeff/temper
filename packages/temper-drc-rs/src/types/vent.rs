...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::vent::tests::test_vent_direction_faces", test_vent_direction_faces),
        ("types::vent::tests::test_vent_direction_not_facing", test_vent_direction_not_facing),
        ("types::vent::tests::test_vent_pair_ok", test_vent_pair_ok),
        ("types::vent::tests::test_vent_pair_facing_err", test_vent_pair_facing_err),
        ("types::vent::tests::test_validate_vent_orientation_ok", test_validate_vent_orientation_ok),
        ("types::vent::tests::test_validate_vent_orientation_violation", test_validate_vent_orientation_violation),
        ("types::vent::tests::test_validate_vent_orientation_no_caps", test_validate_vent_orientation_no_caps),
    ];
