...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::noise::tests::test_net_bundle_phantom_types", test_net_bundle_phantom_types),
        ("types::noise::tests::test_validate_noise_domains_ok", test_validate_noise_domains_ok),
        ("types::noise::tests::test_validate_noise_domains_conflict", test_validate_noise_domains_conflict),
        ("types::noise::tests::test_validate_noise_domains_empty", test_validate_noise_domains_empty),
    ];
