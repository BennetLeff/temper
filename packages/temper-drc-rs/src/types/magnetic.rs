...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::magnetic::tests::test_magnetic_component_trait", test_magnetic_component_trait),
        ("types::magnetic::tests::test_validate_magnetic_void_ok", test_validate_magnetic_void_ok),
        ("types::magnetic::tests::test_validate_magnetic_void_violation", test_validate_magnetic_void_violation),
        ("types::magnetic::tests::test_validate_magnetic_void_unknown_component", test_validate_magnetic_void_unknown_component),
    ];
