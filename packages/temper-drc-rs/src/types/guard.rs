...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::guard::tests::test_guarded_pin_construction", test_guarded_pin_construction),
        ("types::guard::tests::test_validate_guard_ring_ok_with_guard", test_validate_guard_ring_ok_with_guard),
        ("types::guard::tests::test_validate_guard_ring_low_impedance_no_guard_ok", test_validate_guard_ring_low_impedance_no_guard_ok),
        ("types::guard::tests::test_validate_guard_ring_violation", test_validate_guard_ring_violation),
    ];
