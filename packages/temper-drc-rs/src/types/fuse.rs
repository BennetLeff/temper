...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::fuse::tests::test_ipc_2152_external_baseline", test_ipc_2152_external_baseline),
        ("types::fuse::tests::test_ipc_2152_internal_narrower", test_ipc_2152_internal_narrower),
        ("types::fuse::tests::test_fuse_trace_validate_ok", test_fuse_trace_validate_ok),
        ("types::fuse::tests::test_fuse_trace_validate_undersized", test_fuse_trace_validate_undersized),
        ("types::fuse::tests::test_fuse_trace_exact_boundary", test_fuse_trace_exact_boundary),
    ];
