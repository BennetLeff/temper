...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("types::esd::tests::test_esd_connector_requires_return_path", test_esd_connector_requires_return_path),
        ("types::esd::tests::test_validate_esd_path_ok", test_validate_esd_path_ok),
        ("types::esd::tests::test_validate_esd_path_violation", test_validate_esd_path_violation),
        ("types::esd::tests::test_validate_esd_path_exact_boundary", test_validate_esd_path_exact_boundary),
    ];
