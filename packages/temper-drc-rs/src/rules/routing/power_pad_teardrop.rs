...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("rules::routing::power_pad_teardrop::tests::test_distance_to_rect_edge_inside", test_distance_to_rect_edge_inside),
        ("rules::routing::power_pad_teardrop::tests::test_distance_to_rect_edge_outside", test_distance_to_rect_edge_outside),
    ];
