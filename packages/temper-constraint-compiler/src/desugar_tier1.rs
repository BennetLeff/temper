...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("desugar_tier1::tests::test_separation_exceeds_channel_width", test_separation_exceeds_channel_width),
        ("desugar_tier1::tests::test_separation_fits_in_channel", test_separation_fits_in_channel),
        ("desugar_tier1::tests::test_adjacency_soft_tier_emits_zero_constraints", test_adjacency_soft_tier_emits_zero_constraints),
        ("desugar_tier1::tests::test_adjacency_hard_tier_emits_diffpair", test_adjacency_hard_tier_emits_diffpair),
        ("desugar_tier1::tests::test_layer_preference", test_layer_preference),
        ("desugar_tier1::tests::test_advisory_constraints_emit_zero", test_advisory_constraints_emit_zero),
        ("desugar_tier1::tests::test_empty_topology_separation_error", test_empty_topology_separation_error),
        ("desugar_tier1::tests::test_rules_table_size", test_rules_table_size),
        ("desugar_tier1::tests::test_augment_constraint_model", test_augment_constraint_model),
    ];
