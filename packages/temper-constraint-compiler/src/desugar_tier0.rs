...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("desugar_tier0::tests::test_desugar_adjacent", test_desugar_adjacent),
        ("desugar_tier0::tests::test_desugar_separated", test_desugar_separated),
        ("desugar_tier0::tests::test_desugar_inferred_separation", test_desugar_inferred_separation),
        ("desugar_tier0::tests::test_unresolved_component_error", test_unresolved_component_error),
        ("desugar_tier0::tests::test_compile_empty_model", test_compile_empty_model),
        ("desugar_tier0::tests::test_rules_table_size", test_rules_table_size),
        ("desugar_tier0::tests::test_provenance_references_are_valid", test_provenance_references_are_valid),
    ];
