...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("provenance::tests::test_push_and_get", test_push_and_get),
        ("provenance::tests::test_link_clause_and_reverse_map", test_link_clause_and_reverse_map),
        ("provenance::tests::test_empty_unsat_core", test_empty_unsat_core),
        ("provenance::tests::test_conflict_detection_separation_vs_adjacency", test_conflict_detection_separation_vs_adjacency),
        ("provenance::tests::test_no_conflict_when_separation_compatible", test_no_conflict_when_separation_compatible),
        ("provenance::tests::test_layer_preference_conflict", test_layer_preference_conflict),
        ("provenance::tests::test_no_conflict_same_layer_different_nets", test_no_conflict_same_layer_different_nets),
    ];
