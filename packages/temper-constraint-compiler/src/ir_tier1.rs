...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("ir_tier1::tests::test_variant_names", test_variant_names),
        ("ir_tier1::tests::test_display", test_display),
        ("ir_tier1::tests::test_provenance_ref", test_provenance_ref),
        ("ir_tier1::tests::test_channel_topology_shared_channels", test_channel_topology_shared_channels),
        ("ir_tier1::tests::test_channel_topology_channels_for_net", test_channel_topology_channels_for_net),
        ("ir_tier1::tests::test_resolved_constraint_model_empty", test_resolved_constraint_model_empty),
    ];
