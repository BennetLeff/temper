...
pub(crate) mod tests {
    ...
    pub const WASM_TESTS: &[(&str, fn())] = &[
        ("ir_tier0::tests::test_display_formats", test_display_formats),
        ("ir_tier0::tests::test_variant_names", test_variant_names),
        ("ir_tier0::tests::test_tier_ordering", test_tier_ordering),
        ("ir_tier0::tests::test_pcl_constraint_model_all_constraints", test_pcl_constraint_model_all_constraints),
        ("ir_tier0::tests::test_pcl_constraint_model_is_empty", test_pcl_constraint_model_is_empty),
        ("ir_tier0::tests::test_constraint_id_accessor", test_constraint_id_accessor),
    ];
