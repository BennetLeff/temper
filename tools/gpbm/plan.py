...
""",
    ...
    def suggest_tasks_from_context_llm(
        self,
        context_file: Path,
        goal: str,
        role: Optional[str] = None,
        ...
        return self.suggest_tasks_from_context_heuristic(context_file, goal)
...
"""
    ...
    def suggest_tasks_from_context_heuristic(
...
""",
    ...
    tasks = planner.suggest_tasks_from_context_llm(
        context_file, args.goal, args.role, args.domain
    )
