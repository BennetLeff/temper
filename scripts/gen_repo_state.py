...
DIRECTORY_PURPOSE: dict[str, str] = {
    ...
    "crates": "Rust-only crates: no pyproject.toml, not in the uv workspace. Where\n               code lives once it no longer needs an interpreter -- the temper\n               binary and the CP-SAT FFI.",
